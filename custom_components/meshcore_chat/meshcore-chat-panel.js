...
`,fe=/^<[^>]+>\s*/,ye=/@\[([^\]]+)\]/g,be=/@(\w+)/g,_e={recipient_type_entity:"select.meshcore_recipient_type",channel_entity:"select.meshcore_channel",contact_entity:"select.meshcore_contact",channel_entity_pattern:"binary_sensor.meshcore_{prefix}_ch_{idx}_messages",contact_entity_pattern:"binary_sensor.meshcore_{prefix}_{contact}_messages",domain_filter:"meshcore"},xe={..._e,hours_to_show:48,initial_hours:1,max_messages:500,show_date_separators:!0,group_messages:!0,group_timeout:300,timestamp_format:"relative",update_mode:"auto",refresh_interval:30,enable_cache:!0,cache_ttl:86400,cache_max_size:5242880};async function we(e){try{return(await e.callWS({type:"meshcore_chat/get_devices"})).devices||[]}catch{return[]}}async function $e(e,t){try{const i={type:"meshcore_chat/get_contacts"};return t&&(i.entry_id=t),(await e.callWS(i)).contacts||[]}catch{return[]}}async function ke(e,t){try{const i={type:"meshcore_chat/get_channels"};return t&&(i.entry_id=t),(await e.callWS(i)).channels||[]}catch{return[]}}async function Ce(e,t){try{const i={type:"meshcore_chat/get_device_config"};return t&&(i.entry_id=t),await e.callWS(i)}catch{throw new Error("Failed to get device configuration")}}async function Se(e,t,i){try{const o={type:"meshcore_chat/set_device_config",settings:t};return i&&(o.entry_id=i),await e.callWS(o)}catch{return{success:!1,changed:[]}}}async function Me(e,t,i,o){try{const r={type:"meshcore_chat/execute_local",command:t};return i&&(r.args=i),o&&(r.entry_id=o),await e.callWS(r)}catch(e){const t=e;return{response:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function Ae(e,t,i,o){try{const r={type:"meshcore_chat/execute_remote",target_prefix:t,command:i};return o&&(r.entry_id=o),await e.callWS(r)}catch(e){const t=e;return{response:t&&t.message?t.code?`${t.message} (${t.code})`:t.message:String(e),success:!1,timestamp:(new Date).toISOString()}}}async function De(e,t,i,o){try{const r={type:"meshcore_chat/add_contact",public_key:t};return i&&(r.name=i),o&&(r.entry_id=o),await e.callWS(r)}catch{return{success:!1}}}async function ze(e,t,i){try{const o={type:"meshcore_chat/remove_contact",public_key:t};return i&&(o.entry_id=i),await e.callWS(o)}catch{return{success:!1}}}class Re{constructor(){this._counts={},this._lastRead={},this._subscribers=new Set,this._markReadRequestedHandler=null,this._readProgress=null,this._postSwitchTimerHandler=null}subscribe(e){return this._subscribers.add(e),()=>{this._subscribers.delete(e)}}onMarkReadRequested(e){this._markReadRequestedHandler=e}onPostSwitchTimerFire(e){this._postSwitchTimerHandler=e}requestMarkRead(e){e&&this._markReadRequestedHandler&&this._markReadRequestedHandler(e)}_notify(){for(const e of[...this._subscribers])try{e()}catch(e){console.error("[UnreadController] subscriber callback threw",e)}}ingestBackendData(e,t){this._counts={...e?.unread??{}},this._lastRead={...e?.last_read??{}},this._notify()}clearEntity(e){e&&this._counts[e]&&(this._counts={...this._counts,[e]:0},this._notify())}get counts(){return this._counts}get lastRead(){return this._lastRead}beginConversation(e,t){this._clearPostSwitchTimer();const i={entityId:e,anchorId:e?this._lastRead[e]??null:null,unreadCountAtSelection:t,graceUntil:Date.now()+1e3,postSwitchTimer:null,markReadFired:!1,lastMarkReadIdSent:null};this._readProgress=i,i.postSwitchTimer=setTimeout(()=>{this._readProgress===i&&(i.postSwitchTimer=null,this._postSwitchTimerHandler?.())},1e3)}endConversation(){this._clearPostSwitchTimer(),this._readProgress=null}_clearPostSwitchTimer(){const e=this._readProgress;e?.postSwitchTimer&&(clearTimeout(e.postSwitchTimer),e.postSwitchTimer=null)}resetUnreadCountAtSelection(){this._readProgress&&(this._readProgress.unreadCountAtSelection=0)}maybeReanchorOnLateData(e){const t=this._readProgress;if(!t||t.entityId!==e)return!1;if(null!==t.anchorId)return!1;if(t.markReadFired)return!1;const i=this._lastRead[e];return!!i&&(t.anchorId=i,!0)}onScrollState(e){return this._tryAdvanceCursor(e.entityId,e.lastMessageVisible,e.hasNewerMessages,e.bufferTailId,!1)}onPillJump(e){return this._tryAdvanceCursor(e.entityId,!0,!1,e.bufferTailId,!0)}_tryAdvanceCursor(e,t,i,o,r){if(!e)return!1;const s=this._readProgress;return!(!s||s.entityId!==e||!r&&Date.now()<s.graceUntil||i||!t||null!==o&&o===s.lastMarkReadIdSent||(s.lastMarkReadIdSent=o,s.markReadFired=!0,this.requestMarkRead(e),0))}badgeCount(e,t,i){if(!e)return 0;const o=this._counts;if(i&&o[i])return o[i];const r=/^\d+$/.test(e),s=t?`meshcore_${t}_ch_${e}_messages`:null;for(const[t,i]of Object.entries(o))if(!(i<=0))if(r){if(s){if(t.endsWith(s))return i}else if(t.endsWith(`_ch_${e}_messages`))return i}else{const o=e.substring(0,6);if(t.endsWith(`_${o}_messages`))return i}return 0}dividerAfterGroupIdx(e){const t=this._readProgress;if(!t)return null;let i=null;if(t.anchorId){let o=0;for(const r of e)if("date-separator"!==r.type){if(r.group.messages.some(e=>e.id===t.anchorId)){i=o;break}o++}}if(null!==i){let t=0;for(const o of e)if("date-separator"!==o.type){if(t>i&&!o.group.isOutgoing)return t;t++}return null}if(t.unreadCountAtSelection>0){const i=e.filter(e=>"date-separator"!==e.type).length,o=i-t.unreadCountAtSelection;return o>=0?o:0}return null}cursorAtTail(e,t){return!(!e||null===t)&&this._lastRead[e]===t}}const Oe=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298];function Ie(e){const t=(new TextEncoder).encode(e),i=t.length,o=8*i,r=i+9+63&-64,s=new Uint8Array(r);s.set(t),s[i]=128;const a=new DataView(s.buffer);a.setUint32(r-4,o,!1);let n=1779033703,l=3144134277,d=1013904242,c=2773480762,p=1359893119,h=2600822924,g=528734635,u=1541459225;const m=new Int32Array(64);for(let e=0;e<r;e+=64){for(let t=0;t<16;t++)m[t]=a.getInt32(e+4*t,!1);for(let e=16;e<64;e++){const t=(m[e-15]>>>7|m[e-15]<<25)^(m[e-15]>>>18|m[e-15]<<14)^m[e-15]>>>3,i=(m[e-2]>>>17|m[e-2]<<15)^(m[e-2]>>>19|m[e-2]<<13)^m[e-2]>>>10;m[e]=m[e-16]+t+m[e-7]+i|0}let t=n,i=l,o=d,r=c,s=p,v=h,f=g,y=u;for(let e=0;e<64;e++){const a=y+((s>>>6|s<<26)^(s>>>11|s<<21)^(s>>>25|s<<7))+(s&v^~s&f)+Oe[e]+m[e]|0,n=t&i^t&o^i&o;y=f,f=v,v=s,s=r+a|0,r=o,o=i,i=t,t=a+(((t>>>2|t<<30)^(t>>>13|t<<19)^(t>>>22|t<<10))+n|0)|0}n=n+t|0,l=l+i|0,d=d+o|0,c=c+r|0,p=p+s|0,h=h+v|0,g=g+f|0,u=u+y|0}const v=e=>(e>>>0).toString(16).padStart(8,"0");return v(n)+v(l)+v(d)+v(c)+v(p)+v(h)+v(g)+v(u)}function Te(e){const t=[],i=new Set;let o;const r=new RegExp(ye.source,"g");for(;null!==(o=r.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}const s=new RegExp(be.source,"g");for(;null!==(o=s.exec(e));){const e=o[1];i.has(e)||(i.add(e),t.push(e))}return t}function Fe(e){if(!e||0===e.length)return{};let t,i;for(const o of e)void 0===t&&"string"==typeof o.flood_scope&&(t=o.flood_scope),void 0===i&&"boolean"==typeof o.region_scope&&(i=o.region_scope);return{floodScope:t,regionScope:i}}function Ee(e){const t=Fe(e.rx_log_data);return{id:e.id,sender:e.sender,text:e.text,timestamp:new Date(e.timestamp),isOutgoing:e.outgoing,isSystem:!1,raw:e.text,mentions:Te(e.text),rxLogData:e.rx_log_data,deliveryStatus:e.delivery_status?{status:e.delivery_status,ackReceived:e.ack_received,repeaterCount:e.repeater_count,roundTripMs:e.round_trip_ms}:void 0,repeaterCount:e.repeater_count,floodScope:e.flood_scope??t.floodScope,regionScope:e.region_scope??t.regionScope}}function Ne(e,t){return e.getFullYear()!==t.getFullYear()||e.getMonth()!==t.getMonth()||e.getDate()!==t.getDate()}function Pe(e){const t=new Date,i=new Date(t.getFullYear(),t.getMonth(),t.getDate()),o=new Date(e.getFullYear(),e.getMonth(),e.getDate()),r=Math.floor((i.getTime()-o.getTime())/864e5);return 0===r?"Today":1===r?"Yesterday":r<7?e.toLocaleDateString(void 0,{weekday:"long"}):e.toLocaleDateString(void 0,{weekday:"long",month:"long",day:"numeric"})}class Le{constructor(e){this._messages=[],this._loading=!1,this._error=null,this._entityId=null,this._hass=null,this._pollTimer=null,this._realtimeSubscriptions=[],this._retryCount=0,this._onChange=null,this._fetchDebounce=null,this._active=!1,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,this._config=e}get messages(){return this._messages}get loading(){return this._loading}get error(){return this._error}get entityId(){return this._entityId}get loadingOlder(){return this._loadingOlder}get hasOlderMessages(){return this._hasOlderMessages}get loadingNewer(){return this._loadingNewer}get hasNewerMessages(){return this._hasNewerMessages}get newMessagesWhileAway(){return this._newMessagesWhileAway}setUserAtBottom(e){this._userAtBottom!==e&&(this._userAtBottom=e,e&&!this._hasNewerMessages&&this._newMessagesWhileAway>0&&(this._newMessagesWhileAway=0,this._notify()))}resetNewMessagesCounter(){0!==this._newMessagesWhileAway&&(this._newMessagesWhileAway=0,this._notify())}setOnChange(e){this._onChange=e}setHass(e){this._hass=e}setConfig(e){this._config=e}async switchEntity(e,t=null){if(e!==this._entityId){if(this._stopUpdates(),this._entityId=e,this._messages=[],this._error=null,this._retryCount=0,this._hasOlderMessages=!0,this._loadingOlder=!1,this._hasNewerMessages=!1,this._loadingNewer=!1,this._newMessagesWhileAway=0,this._userAtBottom=!1,!e)return this._active=!1,void this._notify();this._active=!0,this._startUpdates(e),t?await this._fetchAroundAnchor(e,t):await this._fetchMessages(e)}}async refresh(){this._entityId&&await this._fetchMessages(this._entityId)}addOptimisticMessage(e,t){const i=new Date,o={id:`optimistic_${i.getTime()}_${Math.random().toString(36).slice(2,8)}`,sender:e,text:t,timestamp:i,isOutgoing:!0,isSystem:!1,raw:`${e}: ${t}`,mentions:[]};this._messages=[...this._messages,o],this._notify()}async loadOlderMessages(){if(!this._loadingOlder&&this._hasOlderMessages&&this._hass&&this._entityId){this._loadingOlder=!0,this._notify();try{const e=this._messages.find(e=>!e.id.startsWith("rt_")&&!e.id.startsWith("optimistic_")),t={type:"meshcore_chat/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.before=e.id);const i=await this._hass.callWS(t),o=i.messages.map(Ee);this._hasOlderMessages=i.has_more;const r=new Set(this._messages.map(e=>e.id)),s=o.filter(e=>!r.has(e.id));s.length>0&&(this._messages=[...s,...this._messages],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()))}catch{}finally{this._loadingOlder=!1,this._notify()}}}async loadNewerMessages(){if(!this._loadingNewer&&this._hasNewerMessages&&this._hass&&this._entityId){this._loadingNewer=!0,this._notify();try{let e;for(let t=this._messages.length-1;t>=0;t--){const i=this._messages[t].id;if(!i.startsWith("rt_")&&!i.startsWith("optimistic_")){e=i;break}}const t={type:"meshcore_chat/get_stored_messages",entity_id:this._entityId,limit:50};e&&(t.after=e);const i=await this._hass.callWS(t),o=i.messages.map(Ee);this._hasNewerMessages=i.has_more;const r=new Set(o.map(e=>e.id));this._messages=this._messages.filter(e=>!e.id.startsWith("rt_")||!r.has(e.id.substring(3)));const s=new Set(this._messages.map(e=>e.id)),a=o.filter(e=>!s.has(e.id));if(a.length>0){this._messages=[...this._messages,...a],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const e=this._config.max_messages??500;this._messages.length>e&&(this._messages=this._messages.slice(-e),this._hasOlderMessages=!0)}}catch{}finally{this._loadingNewer=!1,this._notify()}}}async fetchAroundTimestamp(e){const t=new Date(e).getTime(),i=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(i)return!0;let o=0;for(;this._hasOlderMessages&&o<20;){await this.loadOlderMessages(),o++;const e=this._messages.find(e=>Math.abs(e.timestamp.getTime()-t)<2e3);if(e)return!0}return!1}pause(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null)}async resume(){this._entityId&&!this._active&&(this._active=!0,this._startUpdates(this._entityId),await this._fetchMessages(this._entityId))}destroy(){this._stopUpdates(),this._active=!1,this._fetchDebounce&&(clearTimeout(this._fetchDebounce),this._fetchDebounce=null),this._onChange=null}async _fetchMessages(e){if(this._hass){this._loading=!0,this._notify();try{const t=50,i=await this._hass.callWS({type:"meshcore_chat/get_stored_messages",entity_id:e,limit:t}),o=i.messages.map(Ee);this._hasOlderMessages=i.has_more;const r=new Set(o.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=o.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...o,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const a=this._config.max_messages??500;this._messages.length>a&&(this._messages=this._messages.slice(-a),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}async _fetchAroundAnchor(e,t){if(this._hass){this._loading=!0,this._notify();try{const i=await async function(e,t,i,o=25,r=50){return e.callWS({type:"meshcore_chat/get_messages_around",entity_id:t,anchor_id:i,before_limit:o,after_limit:r})}(this._hass,e,t),o=i.messages.map(Ee);this._hasOlderMessages=i.has_more_before,this._hasNewerMessages=i.has_more_after;const r=new Set(o.map(e=>e.id)),s=this._messages.filter(e=>{if(e.id.startsWith("optimistic_")){const t=o.some(t=>t.sender===e.sender&&t.text===e.text);return!t}if(e.id.startsWith("rt_")){const t=e.id.substring(3);return!r.has(t)}return!1});this._messages=[...o,...s],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const a=this._config.max_messages??500;this._messages.length>a&&(this._messages=this._messages.slice(-a),this._hasOlderMessages=!0),this._error=null,this._retryCount=0}catch(e){const t=e instanceof Error?e.message:String(e);this._error=`Failed to fetch messages: ${t}`,this._retryCount++}finally{this._loading=!1,this._notify()}}}_startUpdates(e){this._startPolling(e),this._subscribeRealtime(e).catch(()=>{})}async _subscribeRealtime(e){if(!this._hass)return;const t=[];try{const i=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleRealtimeMessage(t.data)},"meshcore_message");t.push(i);const o=await this._hass.connection.subscribeEvents(t=>{t.data.entity_id===e&&this._handleDeliveryUpdate(t.data)},"meshcore_delivery_update");t.push(o),this._realtimeSubscriptions=t}catch(e){throw t.forEach(e=>e()),e}}_handleRealtimeMessage(e){const t=e.sender_name??e.sender,i=e.message??e.text;if(t===this._config.node_name){if(t&&i){const o=e.ack_received,r=e.repeater_count,s=e.rx_log_data,a=e.message_type;let n;n="dm"===a||"direct"===a?{status:!0===o?"delivered":"sent",ackReceived:o??void 0}:{status:"sent",repeaterCount:r??s?.length??0};for(let e=this._messages.length-1;e>=0;e--){const o=this._messages[e];if(o.id.startsWith("optimistic_")&&o.sender===t&&o.text===i){o.deliveryStatus=n,s&&(o.rxLogData=s),this._notify();break}}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}else{if(t&&i){let o=i.replace(fe,"");const r=t+": ";o.startsWith(r)&&(o=o.substring(r.length));const s=e.timestamp||(new Date).toISOString(),a=new Date(s),n=function(e,t,i){return Ie(`${e}|${t}|${i}`).substring(0,12)}(s,t,o),l=`rt_${n}`,d=this._messages.some(e=>e.id===l||e.id===n);if(!d){const r=Te(o),s=e.rx_log_data,n={id:l,sender:t,text:o,timestamp:a,isOutgoing:!1,isSystem:!1,raw:i,mentions:r,rxLogData:s&&s.length>0?s:void 0,...Fe(s)};this._messages.push(n),this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime()),this._userAtBottom&&!this._hasNewerMessages||this._newMessagesWhileAway++,this._notify()}}!this._entityId||this._hasNewerMessages||this._hasOlderMessages||this._debouncedFetch(this._entityId)}}_debouncedFetch(e){this._fetchDebounce&&clearTimeout(this._fetchDebounce),this._fetchDebounce=setTimeout(async()=>{if(this._fetchDebounce=null,this._active)try{await this._fetchMessages(e)}catch{}},500)}_handleDeliveryUpdate(e){const t=e.rx_log_data;if(e.progressive&&t&&t.length>0){const i=e.sender_name,o=e.message,r=e.timestamp;if(i&&o){const e=r?new Date(r).getTime():0;for(let r=this._messages.length-1;r>=0;r--){const s=this._messages[r];if(!s.isOutgoing&&s.sender===i&&s.text===o&&(!e||Math.abs(s.timestamp.getTime()-e)<1e4))return s.rxLogData=t,s.repeaterCount=t.length,void this._notify()}}}const i=e.send_id,o=e.status,r=e.repeater_count,s=e.ack_received,a=e.round_trip_ms,n=e.progressive;if(!i)return;let l,d;l=o||(!0===s?"delivered":!n||void 0!==r&&0!==r?"sent":"waiting");for(let e=this._messages.length-1;e>=0;e--)if(this._messages[e].isOutgoing){d=this._messages[e];break}d&&(d.deliveryStatus={status:l,repeaterCount:r,ackReceived:s,roundTripMs:a},void 0!==r&&(d.repeaterCount=r),this._notify())}async _pollFetch(e){if(this._hass&&!this._hasNewerMessages)try{let t;for(let e=this._messages.length-1;e>=0;e--){const i=this._messages[e].id;if(!i.startsWith("rt_")&&!i.startsWith("optimistic_")){t=i;break}}const i={type:"meshcore_chat/get_stored_messages",entity_id:e,limit:50};t&&(i.after=t);const o=await this._hass.callWS(i);if(0===o.messages.length)return this._error=null,void(this._retryCount=0);const r=o.messages.map(Ee),s=new Set(this._messages.map(e=>e.id)),a=r.filter(e=>!s.has(e.id));if(a.length>0){const e=new Set(a.map(e=>e.id));this._messages=this._messages.filter(t=>!t.id.startsWith("rt_")||!e.has(t.id.substring(3))),this._messages=this._messages.filter(e=>!e.id.startsWith("optimistic_")||!a.some(t=>t.sender===e.sender&&t.text===e.text)),this._messages=[...this._messages,...a],this._messages.sort((e,t)=>e.timestamp.getTime()-t.timestamp.getTime());const t=this._config.max_messages??500;this._messages.length>t&&(this._messages=this._messages.slice(-t),this._hasOlderMessages=!0),this._notify()}this._error=null,this._retryCount=0}catch{this._retryCount++}}_startPolling(e){const t=()=>{if(!this._active)return;const i=this._retryCount>=5?6e4:3e4;this._pollTimer=setTimeout(async()=>{if(this._active){try{await this._pollFetch(e)}catch{}t()}},i)};t()}_stopUpdates(){this._pollTimer&&(clearTimeout(this._pollTimer),this._pollTimer=null);for(const e of this._realtimeSubscriptions)e();this._realtimeSubscriptions=[]}_notify(){this._onChange&&this._onChange()}}let qe=class extends de{constructor(){super(...arguments),this.conversations=[],this.activeId=null,this.unreadCounts={},this.nodePrefix=null,this._activeFilter="all",this._filteredConversations=[]}updated(e){(e.has("conversations")||e.has("_activeFilter"))&&this._updateFiltered()}render(){return K`
      ...
      <div
        ...
        ${this._filteredConversations.length>0?this._filteredConversations.map((e,t)=>this._renderConversation(e,t)):K`
    ...
    `}_emptyMessage(){switch(this._activeFilter){case"unread":return"No unread conversations";case"dms":return"No direct messages";case"channels":return"No channels";default:return"No conversations yet"}}_renderConversation(e,t){const i="pubkey_prefix"in e,o=i?e.pubkey_prefix:String(e.channel_idx),r=i?e.adv_name:e.name,s=i?e.pubkey_prefix:`Channel ${e.channel_idx}`,a=i?e.pubkey_prefix.substring(0,2).toUpperCase():`#${e.channel_idx}`,n=this.activeId===o,l=this._getUnreadCount(o),d=l>0?`${r}, ${s}, ${l} unread`:`${r}, ${s}`,c=this._filteredConversations.some(e=>("pubkey_prefix"in e?e.pubkey_prefix:String(e.channel_idx))===this.activeId);return K`
      <div
        ...
        ${l>0?K`<div class="unread-badge" aria-hidden="true">${l}</div>`:K`<span class="chevron" aria-hidden="true">›</span>`}
      </div>
    `}_getUnreadCount(e){return this.unread?this.unread.badgeCount(e,this.nodePrefix):0}_updateFiltered(){switch(this._activeFilter){case"all":this._filteredConversations=[...this.conversations];break;case"unread":this._filteredConversations=this.conversations.filter(e=>{const t="pubkey_prefix"in e?e.pubkey_prefix:String(e.channel_idx);return this._getUnreadCount(t)>0});break;case"dms":this._filteredConversations=this.conversations.filter(e=>"pubkey_prefix"in e);break;case"channels":this._filteredConversations=this.conversations.filter(e=>!("pubkey_prefix"in e))}}};qe.styles=a`
    :host {
      display: flex;
      flex-direction: column;
      height: 100%;
  ...
  `,e([ue({type:Array})],qe.prototype,"conversations",void 0),e([ue({type:String})],qe.prototype,"activeId",void 0),e([ue({attribute:!1})],qe.prototype,"unread",void 0),e([ue({type:Object})],qe.prototype,"unreadCounts",void 0),e([ue({type:String})],qe.prototype,"nodePrefix",void 0),e([me()],qe.prototype,"_activeFilter",void 0),e([me()],qe.prototype,"_filteredConversations",void 0),qe=e([pe("meshcore-conversation-list")],qe);const Be=["a[href]","button:not([disabled])",'input:not([disabled]):not([type="hidden"])',"select:not([disabled])","textarea:not([disabled])",'[tabindex]:not([tabindex="-1"])'].join(","),He=[];let Ve=!1;function Ke(){Ve||(Ve=!0,document.addEventListener("keydown",je,!0))}function je(e){0!==He.length&&He[He.length-1]._handleKeyDown(e)}class Ue{constructor(e,t){this.host=e,this.opts=t,this._wasOpen=!1,this._previousActive=null,this._inStack=!1,this.host.addController(this),Ke()}hostConnected(){Ke()}hostDisconnected(){this._inStack&&this._popStack(),this._previousActive=null,this._wasOpen=!1}hostUpdated(){const e=this.opts.isOpen();if(e&&!this._wasOpen)this._previousActive=this._currentDocumentActive(),this._pushStack(),this._focusFirstSoon();else if(!e&&this._wasOpen){this._popStack();const e=this._previousActive;if(this._previousActive=null,e&&e.isConnected&&"function"==typeof e.focus)try{e.focus()}catch{}}this._wasOpen=e}_pushStack(){this._inStack||(He.push(this),this._inStack=!0)}_popStack(){const e=He.indexOf(this);e>=0&&He.splice(e,1),this._inStack=!1}_getFocusables(){const e=this.opts.getScope?.()??this.host.shadowRoot;return e?Array.from(e.querySelectorAll(Be)).filter(e=>!(e.hasAttribute("aria-hidden")||e.hidden||null===e.offsetParent&&0===e.getClientRects().length)):[]}_focusFirstSoon(){queueMicrotask(()=>{if(!this.opts.isOpen())return;const e=this.opts.getScope?.()??this.host.shadowRoot;if(e&&this._scopeContainsFocus(e))return;const t=this._getFocusables();if(0!==t.length)try{t[0].focus()}catch{}})}_scopeContainsFocus(e){let t=document.activeElement;for(;t;){if(t===e)return!0;if(e.host===t)return!0;if("contains"in e&&e.contains(t))return!0;const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return!1}_currentDocumentActive(){let e=document.activeElement;for(;e&&e.shadowRoot&&e.shadowRoot.activeElement;)e=e.shadowRoot.activeElement;return e}_handleKeyDown(e){if(!this.opts.isOpen())return;if("Escape"===e.key)return e.preventDefault(),e.stopPropagation(),void this.opts.onEscape();if("Tab"!==e.key)return;const t=this._getFocusables();if(0===t.length)return;const i=this.opts.getScope?.()??this.host.shadowRoot,o=i?this._findFocusedInScope(i):null,r=o?t.indexOf(o):-1;let s;s=e.shiftKey?r<=0?t.length-1:r-1:-1===r||r>=t.length-1?0:r+1,e.preventDefault(),e.stopPropagation();try{t[s].focus()}catch{}}_findFocusedInScope(e){let t=document.activeElement;for(;t;){if(e===t||"contains"in e&&e.contains(t)){if(t.shadowRoot&&t.shadowRoot.activeElement){t=t.shadowRoot.activeElement;continue}return t}if(e.host===t){t=e.activeElement;continue}const i=t.shadowRoot;if(!i||!i.activeElement)break;t=i.activeElement}return null}}function We(e,t){new Ue(e,t)}let Ge=class extends de{constructor(){super(),this.open=!1,this.narrow=!1,this.editMode=!1,this.initialChannelIdx=0,this.initialChannelName="",this.initialScope="",this.initialKey="",this.availableIndices=[],this._channelIdx=0,this._channelName="",this._customKey="",this._autoKey=!0,this._scope="",this._availableScopes=null,this._globalAllowed=!1,this._saving=!1,this._error=null,this._initialized=!1,We(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}willUpdate(e){if(e.has("open")&&this.open&&!this._initialized){if(this.editMode){this._channelIdx=this.initialChannelIdx,this._channelName=this.initialChannelName,this._scope=this.initialScope;const e=Ie(this.initialChannelName).slice(0,32);this.initialKey&&this.initialKey.toLowerCase()!==e?(this._autoKey=!1,this._customKey=this.initialKey.toLowerCase()):(this._autoKey=!0,this._customKey="")}else this._channelIdx=this.availableIndices.length>0?this.availableIndices[0]:0;this._initialized=!0,this._loadScopes()}e.has("open")&&!this.open&&(this._initialized=!1)}async _loadScopes(){if(this._availableScopes=null,!this.hass)return this._availableScopes=[],void(this._globalAllowed=!1);const e=await async function(e,t){try{const i={type:"meshcore_chat/get_flood_scopes"};t&&(i.entry_id=t);const o=await e.callWS(i);return{scopes:o.scopes||[],global:!!o.global}}catch{return{scopes:[],global:!1}}}(this.hass,this.entryId);this._availableScopes=e.scopes,this._globalAllowed=e.global}render(){if(!this.open)return;const e=this._customKey.length,t=32===e||0===e||this._autoKey;return K`
      <div
        ...
        <div
          ...
          <div class="dialog-body">
            ${this._error?K`<div style="padding: 12px; background: rgba(219, 68, 55, 0.1); border-radius: 6px; color: var(--error-color, #db4437); font-size: 13px; margin-bottom: 16px;">
                  ${this._error}
                </div>`:""}
    ...
    `}_renderScopeField(){const e=this._availableScopes;if(null===e)return K`
        <select class="form-select scope-select" disabled>
          <option selected>Loading…</option>
        </select>
      `;const t=this._globalAllowed?"*":"",i=!this._scope||"*"===this._scope,o=!!this._scope&&"*"!==this._scope&&!e.includes(this._scope);return 0!==e.length||o||this._globalAllowed?K`
      <select
        class="form-select scope-select"
        @change=${e=>{this._scope=e.target.value}}>
        <option value=${t} ?selected=${i}>All regions (global flood)</option>
        ${o?K`<option value=${this._scope} selected>${this._scope} (not in allowlist)</option>`:""}
        ${e.map(e=>K`
    ...
    `],e([ue({type:Boolean})],Ge.prototype,"open",void 0),e([ue({type:Object})],Ge.prototype,"hass",void 0),e([ue({type:String})],Ge.prototype,"entryId",void 0),e([ue({type:Boolean})],Ge.prototype,"narrow",void 0),e([ue({type:Boolean})],Ge.prototype,"editMode",void 0),e([ue({type:Number})],Ge.prototype,"initialChannelIdx",void 0),e([ue({type:String})],Ge.prototype,"initialChannelName",void 0),e([ue({type:String})],Ge.prototype,"initialScope",void 0),e([ue({type:String})],Ge.prototype,"initialKey",void 0),e([ue({type:Array})],Ge.prototype,"availableIndices",void 0),e([me()],Ge.prototype,"_channelIdx",void 0),e([me()],Ge.prototype,"_channelName",void 0),e([me()],Ge.prototype,"_customKey",void 0),e([me()],Ge.prototype,"_autoKey",void 0),e([me()],Ge.prototype,"_scope",void 0),e([me()],Ge.prototype,"_availableScopes",void 0),e([me()],Ge.prototype,"_globalAllowed",void 0),e([me()],Ge.prototype,"_saving",void 0),e([me()],Ge.prototype,"_error",void 0),Ge=e([pe("meshcore-channel-dialog")],Ge);let Xe=class extends de{willUpdate(){this._tabInitialized||(this._tabInitialized=!0,this.initialTab&&(this._activeTab=this.initialTab))}constructor(){super(),this.narrow=!1,this._tabInitialized=!1,this._activeTab="contacts",this._contacts=[],this._channels=[],this._searchQuery="",this._categoryFilter="all",this._typeFilter="all",this._loading=!1,this._actionInProgress=null,this._confirmingRemoveContact=null,this._confirmingRemoveChannel=null,this._channelDialogOpen=!1,this._editingChannel=null,this._maxChannels=4,We(this,{isOpen:()=>!0,onEscape:()=>this._close()})}connectedCallback(){super.connectedCallback(),this._loadData()}render(){return K`
      <div
        class="dialog"
        role="dialog"
        aria-modal="true"
        ...
        ${"contacts"===this._activeTab?K`
              <div class="filter-bar">
                <span class="filter-bar-label">Show</span>
                <div class="filter-bar-group">
                  ${["all","added","discovered"].map(e=>K`
                      <button
        ...
        <div class="list-area">
          ${this._loading?K`<div class="loading-state">
      ...
      ${this._channelDialogOpen?K`
            <meshcore-channel-dialog
              ...
              .initialKey=${this._editingChannel?.settings?.channel_secret??""}
            ...
            ></meshcore-channel-dialog>
          `:""}
    `}_renderContacts(){const e=this._filterContacts();if(0===e.length){const e=!!this._searchQuery||"all"!==this._categoryFilter||"all"!==this._typeFilter;return K`
        <div class="empty-state">
        ...
        <div class="contact-info">
          ...
          <div class="contact-meta">
            ...
            <span class="badge ${i?"added":"discovered"}">
              ${i?K`<svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor" style="vertical-align: -1px; margin-right: 2px;"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>Added`:"Discovered"}
            </span>
          </div>
        </div>
        ${o?K`
            ...
            `:i?K`
              ...
              `:K`
                <button
                  ...
                  ${r?"...":K`<svg viewBox="0 0 24 24" width="12" height="12" fill="currentColor" style="vertical-align: -1px; margin-right: 4px;"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>Add`}
                </button>
              `}
      </div>
    `}_renderChannels(){if(0===this._channels.length)return K`
        <div class="empty-state">
      ...
      `;const e=this._confirmingRemoveChannel;return K`
      ${this._channels.map(t=>{const i=e===t.channel_idx,o=this._actionInProgress===`ch-${t.channel_idx}`;return K`
          <div class="channel-item">
            <div class="channel-icon">#</div>
            <div class="channel-info">
              <div class="channel-name">${t.name}</div>
              <div class="channel-idx">Index ${t.channel_idx}${t.scope?K` · scope: ${t.scope}`:""}</div>
            </div>
            ${i?K`
                  <div class="confirm-inline">
                    <span class="confirm-text">Remove?</span>
  ...
  `,e([ue({type:Object})],Xe.prototype,"hass",void 0),e([ue({type:String})],Xe.prototype,"entryId",void 0),e([ue({type:Boolean})],Xe.prototype,"narrow",void 0),e([ue({type:String})],Xe.prototype,"initialTab",void 0),e([me()],Xe.prototype,"_activeTab",void 0),e([me()],Xe.prototype,"_contacts",void 0),e([me()],Xe.prototype,"_channels",void 0),e([me()],Xe.prototype,"_searchQuery",void 0),e([me()],Xe.prototype,"_categoryFilter",void 0),e([me()],Xe.prototype,"_typeFilter",void 0),e([me()],Xe.prototype,"_loading",void 0),e([me()],Xe.prototype,"_actionInProgress",void 0),e([me()],Xe.prototype,"_confirmingRemoveContact",void 0),e([me()],Xe.prototype,"_confirmingRemoveChannel",void 0),e([me()],Xe.prototype,"_channelDialogOpen",void 0),e([me()],Xe.prototype,"_editingChannel",void 0),e([me()],Xe.prototype,"_maxChannels",void 0),Xe=e([pe("meshcore-manage-dialog")],Xe);let Ye=class extends de{constructor(){super(),this.timestampFormat="relative",this._selectedMessage=null,We(this,{isOpen:()=>null!==this._selectedMessage,onEscape:()=>{this._selectedMessage=null},getScope:()=>this.shadowRoot?.querySelector(".message-dialog")})}render(){return this.group?K`
        ${this._renderGroup()}
        ${this._selectedMessage?this._renderMessageDialog(this._selectedMessage):K``}
      `:K``}_renderGroup(){if(!this.group)return K``;const e=this.group,t={"message-group":!0,incoming:!e.isOutgoing&&!e.isSystem,outgoing:e.isOutgoing,system:e.isSystem};let i;return e.messages.length>0&&(i=e.messages[0].senderColor||function(e){let t=0;for(let i=0;i<e.length;i++)t=(t<<5)-t+e.charCodeAt(i);const i=["#e57373","#64b5f6","#81c784","#ffb74d","#ba68c8","#4dd0e1","#fff176","#a1887f"];return i[Math.abs(t)%i.length]}(e.sender)),K`
      <div class=${this._classMap(t)} style=${i?`--sender-color: ${i}`:""}>
        ${e.isSystem||e.isOutgoing?K``:K`<div class="sender">${e.sender}</div>`}
        ${e.messages.map(e=>this._renderBubble(e))}
      </div>
    `}_renderBubble(e){const t={bubble:!0,incoming:!e.isOutgoing&&!e.isSystem,outgoing:e.isOutgoing,system:e.isSystem},i=e.isOutgoing&&e.deliveryStatus?this._getStatusLabel(e.deliveryStatus):"",o=function(e,t){switch(t){case"relative":default:return function(e){const t=Date.now()-e.getTime(),i=Math.floor(t/1e3),o=Math.floor(i/60),r=Math.floor(o/60);return i<60?"now":o<60?`${o}m`:r<24?`${r}h`:e.toLocaleDateString(void 0,{month:"short",day:"numeric"})}(e);case"time":return e.toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit"});case"datetime":return e.toLocaleString(void 0,{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}}(e.timestamp,this.timestampFormat),r=e.isOutgoing||e.isSystem||!e.floodScope?"":"*"===e.floodScope?"🌐 all regions":e.floodScope;return K`
    ...
    `}_getStatusLabel(e){const t=e.status,i=e.repeaterCount??0;switch(t){case"pending":case"waiting":return"Waiting...";case"sent":return i>0?"Repeated":"Unheard";case"delivered":return"Delivered";case"failed":return"Failed";default:return"Sent"}}_renderTextWithMentions(e,t){if(0===t.length)return e;const i=t.map(e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")),o=new RegExp(`@\\[(${i.join("|")})\\]|@(${i.join("|")})\\b`,"g"),r=[];let s,a=0;for(;null!==(s=o.exec(e));){s.index>a&&r.push(e.slice(a,s.index));const t=s[1]??s[2];r.push(K`<span class="mention">@${t}</span>`),a=s.index+s[0].length}return a<e.length&&r.push(e.slice(a)),r}_renderMessageDialog(e){const t=e.rxLogData&&e.rxLogData.length>0,i=t?e.rxLogData.map(e=>{const t=e.path_nodes,i=e.hop_count,o=e.snr,r=e.rssi,s=[];return t&&t.length>0?s.push(t.map(e=>e.substring(0,4).toUpperCase()).join(" > ")):void 0!==i?s.push(`${i} hop${1!==i?"s":""}`):s.push("0 hops"),void 0!==o&&s.push(`SNR: ${o}`),void 0!==r&&s.push(`RSSI: ${r}`),s.join(" · ")}).join(" | "):"",o=e.timestamp.toLocaleString(void 0,{weekday:"short",month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit",second:"2-digit"}),r="padding: 8px 16px; font-size: 12px; color: var(--secondary-text-color); border-top: 1px solid var(--divider-color, #e0e0e0);";return K`
      <div class="message-dialog-overlay" @click=${()=>{this._selectedMessage=null}}>
        <div class="message-dialog"
          ...
          ${e.isOutgoing&&e.deliveryStatus?K`
                <div style=${r}>
  ...
  `,e([ue({type:Object})],Ye.prototype,"group",void 0),e([ue({type:Object})],Ye.prototype,"message",void 0),e([ue({type:String})],Ye.prototype,"timestampFormat",void 0),e([me()],Ye.prototype,"_selectedMessage",void 0),Ye=e([pe("meshcore-message-bubble")],Ye);let Qe=class extends de{constructor(){super(),this._query="",this._fromDate="",this._toDate="",this._results=[],this._totalCount=0,this._searching=!1,this._hasSearched=!1,this._showFilters=!1,this._debounceTimer=null,We(this,{isOpen:()=>!0,onEscape:()=>this.dispatchEvent(new CustomEvent("search-close",{bubbles:!0,composed:!0}))})}render(){return K`
      <div class="search-header">
        ...
        ${this._showFilters?K`
            ...
            `:""}
        ${this._hasSearched?K`<div class="result-count">${this._totalCount} result${1!==this._totalCount?"s":""}</div>`:""}
      </div>

      <div class="results">
        ${this._searching?K`<div class="loading-state">Searching...</div>`:this._hasSearched?0===this._results.length?K`
                  <div class="empty-state">
                ...
                `:this._results.map(e=>this._renderResult(e)):K`
                <div class="empty-state">
    ...
    `}_renderResult(e){const t=new Date(e.timestamp),i=t.toLocaleDateString(void 0,{month:"short",day:"numeric"}),o=t.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}),r=this._highlightQuery(e.text);return K`
  ...
  `,e([ue({type:Object})],Qe.prototype,"hass",void 0),e([ue({type:String})],Qe.prototype,"entryId",void 0),e([ue({type:String})],Qe.prototype,"entityId",void 0),e([ue({type:String})],Qe.prototype,"meshNodeName",void 0),e([me()],Qe.prototype,"_query",void 0),e([me()],Qe.prototype,"_fromDate",void 0),e([me()],Qe.prototype,"_toDate",void 0),e([me()],Qe.prototype,"_results",void 0),e([me()],Qe.prototype,"_totalCount",void 0),e([me()],Qe.prototype,"_searching",void 0),e([me()],Qe.prototype,"_hasSearched",void 0),e([me()],Qe.prototype,"_showFilters",void 0),Qe=e([pe("meshcore-message-search")],Qe);let Je=class extends de{constructor(){super(...arguments),this.conversations=[],this.selectedId=null,this.narrow=!1,this.lastRead={},this._messageStore=null,this._unsubUnread=null,this._inputText="",this._sending=!1,this._viewportNarrow=!1,this._mediaQuery=null,this._mediaHandler=null,this._narrowShowMessages=!1,this._manageOpen=!1,this._manageInitialTab="contacts",this._searchOpen=!1,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._scrollInFlight=!1,this._scrollGuardUntil=0,this._lastMessageCount=0}get _isNarrow(){return this.narrow||this._viewportNarrow}connectedCallback(){super.connectedCallback(),this.config&&!this._messageStore&&(this._messageStore=new Le(this.config),this._messageStore.setOnChange(()=>this.requestUpdate())),this.unread&&!this._unsubUnread&&(this._unsubUnread=this.unread.subscribe(()=>{this.lastRead=this.unread.lastRead,this.requestUpdate()}),this.lastRead=this.unread.lastRead,this.unread.onPostSwitchTimerFire(()=>this._checkAndMarkReadIfAtBottom())),this._mediaQuery=window.matchMedia("(max-width: 870px)"),this._viewportNarrow=this._mediaQuery.matches,this._mediaHandler=e=>{this._viewportNarrow=e.matches},this._mediaQuery.addEventListener("change",this._mediaHandler)}disconnectedCallback(){super.disconnectedCallback(),this._messageStore&&(this._messageStore.destroy(),this._messageStore=null),this._unsubUnread&&(this._unsubUnread(),this._unsubUnread=null),this.unread?.endConversation(),this._mediaQuery&&this._mediaHandler&&(this._mediaQuery.removeEventListener("change",this._mediaHandler),this._mediaQuery=null,this._mediaHandler=null)}updated(e){if(e.has("hass")&&this.hass&&this._messageStore&&this._messageStore.setHass(this.hass),e.has("config")&&this.config&&this._messageStore){this._messageStore.setConfig(this.config);const t=e.get("config");t&&t.entry_id!==this.config.entry_id&&(this.selectedId=null,this._currentEntityId=null,this._conversationResolved=!1,this._pendingScroll=null,this._lastMessageCount=0,this.unread.endConversation(),this._messageStore.switchEntity(null),this.dispatchEvent(new CustomEvent("active-entity-changed",{detail:{entityId:null},bubbles:!0,composed:!0})))}if(e.has("selectedId")&&this._onConversationSelected(),e.has("lastRead")&&this._currentEntityId&&this._conversationResolved&&null===this._pendingScroll&&this.unread.maybeReanchorOnLateData(this._currentEntityId)&&(this._pendingScroll="last-read"),this._pendingScroll){const e=this._messageStore,t=e&&!e.loading;t&&e.messages.length>0?(this._executeScroll(this._pendingScroll),this._pendingScroll=null,this._lastMessageCount=e.messages.length):t&&0===e.messages.length&&(this._pendingScroll=null)}else if(this._messageStore){const e=this._messageStore.messages.length;e>this._lastMessageCount&&this._lastMessageCount>0&&this._scrollToBottomIfNearEnd(),this._lastMessageCount=e}}render(){return this._isNarrow?this._narrowShowMessages?K`
    ...
    `}_renderChatArea(){if(!this._messageStore||!this.selectedId)return K`
        <div class="empty-state">
      ...
      `;if(!this._conversationResolved)return K`
        <div class="empty-state">
      ...
      <div class="chat-container" @reply-to-sender=${this._onReplyToSender} @scroll=${this._onChatScroll}>
        ...
        ${this._messageStore.error?K`
            ...
            `:K``}
        ${this._messageStore.loading&&0===e.length?K`
              <div class="loading-state">
                <div class="loading-spinner"></div>
                Loading messages...
              </div>
            `:K``}
        ${0!==t.length||this._messageStore.loading?K``:K`
              <div class="empty-state">
    ...
    `}_renderItemsWithDivider(e){const t=[];let i=0,o=!1;const r=this.unread.dividerAfterGroupIdx(e);for(const s of e)"date-separator"!==s.type?(o||null===r||i!==r||(t.push(K`
  ...
  `,e([ue({type:Object})],Je.prototype,"hass",void 0),e([ue({type:Object})],Je.prototype,"config",void 0),e([ue({type:Array})],Je.prototype,"conversations",void 0),e([ue({type:String})],Je.prototype,"selectedId",void 0),e([ue({type:Boolean})],Je.prototype,"narrow",void 0),e([ue({attribute:!1})],Je.prototype,"unread",void 0),e([ue({type:Object})],Je.prototype,"lastRead",void 0),e([me()],Je.prototype,"_messageStore",void 0),e([me()],Je.prototype,"_inputText",void 0),e([me()],Je.prototype,"_sending",void 0),e([me()],Je.prototype,"_viewportNarrow",void 0),e([me()],Je.prototype,"_narrowShowMessages",void 0),e([me()],Je.prototype,"_manageOpen",void 0),e([me()],Je.prototype,"_manageInitialTab",void 0),e([me()],Je.prototype,"_searchOpen",void 0),e([me()],Je.prototype,"_currentEntityId",void 0),e([me()],Je.prototype,"_conversationResolved",void 0),e([me()],Je.prototype,"_pendingScroll",void 0),Je=e([pe("meshcore-chat-page")],Je);class Ze{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const et=(tt=class extends Ze{constructor(e){if(super(e),this._timer=null,this._startX=0,this._startY=0,this._attached=!1,this._callback=null,this._element=null,this._onPointerDown=e=>this._handleDown(e),this._onPointerUp=()=>this._cancelTimer(),this._onPointerMove=e=>this._handleMove(e),this._onContextMenu=e=>{null!==this._timer&&e.preventDefault()},6!==e.type)throw new Error("longPress directive must be used on an element")}render(e){}update(e,[t]){if(this._callback=t,!this._attached){this._element=e.element;const t=this._element;t.addEventListener("pointerdown",this._onPointerDown),t.addEventListener("pointerup",this._onPointerUp),t.addEventListener("pointercancel",this._onPointerUp),t.addEventListener("pointermove",this._onPointerMove),t.addEventListener("contextmenu",this._onContextMenu),this._attached=!0}return this.render(t)}_handleDown(e){0===e.button&&(this._startX=e.clientX,this._startY=e.clientY,this._cancelTimer(),this._timer=setTimeout(()=>{this._timer=null,this._callback?.()},500))}_handleMove(e){if(null===this._timer)return;const t=e.clientX-this._startX,i=e.clientY-this._startY;t*t+i*i>100&&this._cancelTimer()}_cancelTimer(){null!==this._timer&&(clearTimeout(this._timer),this._timer=null)}},(...e)=>({_$litDirective$:tt,values:e}));var tt;let it=class extends de{constructor(){super(...arguments),this.entityId="",this.label="",this.icon="",this.colorScheme="neutral"}render(){if(!this.hass||!this.entityId)return W;const e=this.hass.states[this.entityId];if(!e)return W;const t=e.state,i=e.attributes?.unit_of_measurement||"",o=this.label||e.attributes?.friendly_name||this.entityId,r="unavailable"===t||"unknown"===t,s=this.hass.entities?.[this.entityId]?.display_precision;let a="";if("battery"===this.colorScheme){const e=parseFloat(t);isNaN(e)||(a=e>50?"battery-high":e>20?"battery-medium":"battery-low")}else"signal"===this.colorScheme&&(a="signal");return K`
      <div class="tile ${r?"unavailable":""}"
           @click=${this._openMoreInfo}
           @contextmenu=${this._onRightClick}
           ${et(()=>this._onRightClick(new MouseEvent("contextmenu")))}>
        <div class="tile-value-row">
          ${this.icon?K`<span class="tile-icon ${a}">${this._renderIcon()}</span>`:W}
          <span>${r?"—":this._formatValue(t,s)}${i?K`<span class="tile-unit">${i}</span>`:W}</span>
        </div>
        <div class="tile-label">${o}</div>
      </div>
    `}_openMoreInfo(){if(!this.entityId)return;const e=new CustomEvent("hass-more-info",{detail:{entityId:this.entityId},bubbles:!0,composed:!0});this.dispatchEvent(e)}_onRightClick(e){e.preventDefault(),this.entityId&&this.dispatchEvent(new CustomEvent("tile-context-menu",{detail:{entityId:this.entityId,label:this.label},bubbles:!0,composed:!0}))}_formatValue(e,t){const i=parseFloat(e);return isNaN(i)?e:null!=t&&t>=0?i.toFixed(t):e.includes(".")?e:i.toString()}_renderIcon(){switch(this.icon){case"battery":return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M15.67 4H14V2h-4v2H8.33C7.6 4 7 4.6 7 5.33v15.33C7 21.4 7.6 22 8.33 22h7.33c.74 0 1.34-.6 1.34-1.33V5.33C17 4.6 16.4 4 15.67 4z"/></svg>`;case"signal":return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`;case"clock":return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/></svg>`;case"power":return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M16.01 7L16 3h-2v4h-4V3H8v4h-.01C7 6.99 6 7.99 6 8.99v5.49L9.5 18v3h5v-3l3.5-3.51v-5.5c0-1-1-2-1.99-1.99z"/></svg>`;case"thermometer":return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M15 13V5c0-1.66-1.34-3-3-3S9 3.34 9 5v8c-1.21.91-2 2.37-2 4 0 2.76 2.24 5 5 5s5-2.24 5-5c0-1.63-.79-3.09-2-4zm-4-8c0-.55.45-1 1-1s1 .45 1 1h-1v1h1v2h-1v1h1v2h-2V5z"/></svg>`;case"counter":return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`;case"chart":return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M3.5 18.49l6-6.01 4 4L22 6.92l-1.41-1.41-7.09 7.97-4-4L2 16.99z"/></svg>`;default:return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 14c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z"/></svg>`}}};it.styles=a`
    :host {
      display: block;
    }
  ...
  `,e([ue({type:Number})],at.prototype,"value",void 0),e([ue({type:Number})],at.prototype,"min",void 0),e([ue({type:Number})],at.prototype,"max",void 0),e([ue({type:String})],at.prototype,"band",void 0),at=e([pe("meshcore-stat-bar")],at);let nt=class extends de{constructor(){super(...arguments),this.segments=[],this.legend="below"}_denom(){if(void 0!==this.total&&this.total>0)return this.total;const e=this.segments.reduce((e,t)=>e+(Number.isFinite(t.value)?t.value:0),0);return e>0?e:1}render(){if(!this.segments.length)return W;const e=this._denom();return K`
      <div class="stat-bar"
           role="img"
           aria-label="${this.segments.map(e=>`${e.label} ${e.value}`).join(", ")}">
        ${this.segments.map(t=>{const i=Number.isFinite(t.value)?Math.max(0,t.value):0;if(0===i)return W;const o=i/e*100;return K`<div class="stat-bar-segment ${t.kind}"
                           style="width: ${o}%"
                           title="${t.label}: ${t.value}"></div>`})}
      </div>
      ${"none"!==this.legend?K`
          <div class="stat-bar-legend ${"inline"===this.legend?"inline":""}">
            ${this.segments.filter(e=>Number.isFinite(e.value)&&e.value>=0).map(e=>K`<span><span class="legend-swatch ${e.kind}"></span>${e.label}</span>`)}
            ${this.extraLegendText?K`<span class="legend-extra">${this.extraLegendText}</span>`:W}
          </div>`:W}
    `}};nt.styles=a`
  ...
  `,e([ue({type:Array})],nt.prototype,"segments",void 0),e([ue({type:Number})],nt.prototype,"total",void 0),e([ue({type:String})],nt.prototype,"legend",void 0),e([ue({type:String})],nt.prototype,"extraLegendText",void 0),nt=e([pe("meshcore-stacked-bar")],nt);let lt=class extends de{constructor(){super(...arguments),this.content="",this._open=!1,this._onOpen=()=>{this._open||(this._open=!0,window.addEventListener("scroll",this._onScroll,!0))},this._onClose=()=>{this._open&&(this._open=!1,window.removeEventListener("scroll",this._onScroll,!0))},this._onScroll=()=>this._onClose()}render(){return this.content?K`
  ...
  `,e([ue({type:String})],lt.prototype,"content",void 0),e([ue({type:String})],lt.prototype,"source",void 0),e([me()],lt.prototype,"_open",void 0),lt=e([pe("meshcore-info-tip")],lt);const dt=[{key:"sent_flood",label:"Sent · Flood",color:"var(--info, #2196f3)",dash:!1},{key:"sent_direct",label:"Sent · Direct",color:"var(--info, #2196f3)",dash:!0},{key:"recv_flood",label:"Recv · Flood",color:"var(--good, #4caf50)",dash:!1},{key:"recv_direct",label:"Recv · Direct",color:"var(--good, #4caf50)",dash:!0},{key:"errors",label:"Errors",color:"var(--bad, #f44336)",dash:!1}];let ct=class extends de{constructor(){super(...arguments),this.data=[],this.width=700,this.height=170,this.timeRange=48,this._hoverIndex=null,this._onPointerMove=e=>{const t=this._indexFromEvent(e);null!=t&&t!==this._hoverIndex&&(this._hoverIndex=t)},this._onPointerDown=e=>{const t=this._indexFromEvent(e);null!=t&&(this._hoverIndex=t===this._hoverIndex?null:t)},this._onPointerLeave=e=>{"mouse"===e.pointerType&&(this._hoverIndex=null)}}render(){return this.data&&0!==this.data.length?K`
    ...
    `:W}_timeLabel(e,t){const i=Math.round((t-e)/36e5);return i<=0?"now":`-${i}h`}_fmtValue(e){return"number"==typeof e&&isFinite(e)?0===e?"0":e<1?e.toFixed(2):e.toFixed(1):"—"}_geom(){const e=this.width,t=this.height,i=e-40-12,o=t-12-22;let r=0;for(const e of this.data)for(const t of dt){const i=e.values[t.key];"number"==typeof i&&isFinite(i)&&(r=Math.max(r,i))}r<=0&&(r=1);const s=Date.now(),a=36e5*this.timeRange,n=s-a;return{padL:40,padR:12,padT:12,padB:22,w:e,h:t,cw:i,ch:o,maxV:r,now:s,range:a,oldest:n,xScale:e=>40+(e-n)/a*i,yScale:e=>12+o-e/r*o}}_nearestBucket(e){const{xScale:t}=this._geom();let i=-1,o=1/0;for(let r=0;r<this.data.length;r++){const s=Math.abs(t(this.data[r].timestamp)-e);s<o&&(o=s,i=r)}return i}_indexFromEvent(e){const t=this.renderRoot.querySelector("svg");if(!t||0===this.data.length)return null;const i=t.getBoundingClientRect();if(0===i.width)return null;const o=(e.clientX-i.left)/i.width*this.width;return this._nearestBucket(o)}_renderChart(){const e=this._geom(),{padL:t,padR:i,padT:o,padB:r,w:s,h:a,ch:n,maxV:l,now:d,range:c,oldest:p,xScale:h,yScale:g}=e,u=[0,l/2,l].map(e=>{const o=g(e);return j`
        ...
        <text x="${t-6}" y="${o+3}" font-size="9" text-anchor="end"
          fill="var(--secondary-text-color,#727272)">${e<1?e.toFixed(1):Math.round(e)}</text>`}),m=[p,p+c/2,d].map(e=>j`
        <text x="${h(e)}" y="${a-r+14}" font-size="9" text-anchor="middle"
          fill="var(--secondary-text-color,#727272)">${this._timeLabel(e,d)}</text>`),v=dt.map(e=>{const t=this.data.filter(t=>"number"==typeof t.values[e.key]&&isFinite(t.values[e.key])).map(t=>`${h(t.timestamp).toFixed(1)},${g(t.values[e.key]).toFixed(1)}`);if(0===t.length)return j``;if(1===t.length){const[i,o]=t[0].split(",");return j`<circle cx="${i}" cy="${o}" r="2" fill="${e.color}" />`}return j`<polyline points="${t.join(" ")}" fill="none" stroke="${e.color}"
        stroke-width="1.5" stroke-dasharray="${e.dash?"5,3":"none"}"
        stroke-linecap="round" stroke-linejoin="round" />`});let f=j``;if(null!=this._hoverIndex&&this._hoverIndex<this.data.length){const e=this.data[this._hoverIndex],t=h(e.timestamp),i=dt.map(i=>{const o=e.values[i.key];return"number"==typeof o&&isFinite(o)?j`<circle cx="${t}" cy="${g(o)}" r="3" fill="${i.color}"
      ...
      </svg>`}_renderTooltip(){const e=this._hoverIndex;if(null==e||e>=this.data.length)return W;const t=this._geom(),i=this.data[e],o=t.xScale(i.timestamp)/t.w*100,r=o>55,s=new Date(i.timestamp).toLocaleString([],{weekday:"short",hour:"2-digit",minute:"2-digit"});return K`
  ...
  `,e([ue({type:Array})],ct.prototype,"data",void 0),e([ue({type:Number})],ct.prototype,"width",void 0),e([ue({type:Number})],ct.prototype,"height",void 0),e([ue({type:Number})],ct.prototype,"timeRange",void 0),e([me()],ct.prototype,"_hoverIndex",void 0),ct=e([pe("meshcore-message-rate-chart")],ct);let pt=class extends de{constructor(){super(...arguments),this.entities=[],this.hiddenCount=0,this._rateHistory=[],this._rateHistoryKey=null}render(){if(!this.hass||!this.device)return W;const e=new Set,t=this._renderHeroTiles(e),i=this._buildGroups(e);return K`
      <div class="hero-row">
        ${t}
      </div>
    ...
    `:W}_renderHeroTiles(e){const t=this.device;return"companion"===t.type?this._renderCompanionHero(e):"repeater"===t.type?this._renderRepeaterHero(e):this._renderClientHero(e)}_renderRepeaterHero(e){return K`
    ...
    `}_renderClientHero(e){return K`
      ${this._renderBatteryTile()}
      ${this._renderSignalTile()}
      ${this._renderRequestsTile(e)}
    `}_renderCompanionHero(e){return K`
      ${this._renderBatteryTile()}
      ${this._renderSignalTile()}
    ...
    `}_renderBatteryTile(){const e=this._findByMetric("battery_pct");if(!e)return W;const t=this._readNumber(e.entity_id),i=this._findEntityIdMatching("battery_voltage")??this._findEntityByLabel("Voltage"),o=i?this._readNumber(i.entity_id):NaN,r=st("battery_pct",t);return K`
      <div class="hero-tile" @click=${()=>this._fireMoreInfo(e.entity_id)}>
        ...
        <div class="hero-tile-value">
          ...
          ${Number.isFinite(o)?K`<span class="secondary">· ${o.toFixed(3)} V</span>`:W}
        </div>
        <meshcore-stat-bar
          .value=${t}
          .min=${0}
    ...
    `}_renderSignalTile(){const e=this._findByMetric("rssi");if(!e)return W;const t=this._readNumber(e.entity_id),i=this._findByMetric("snr"),o=i?this._readNumber(i.entity_id):NaN,r=st("rssi",t);return K`
      <div class="hero-tile" @click=${()=>this._fireMoreInfo(e.entity_id)}>
        <div class="hero-tile-head">
        ...
        <div class="hero-tile-value">
          ...
          ${Number.isFinite(o)?K`<span class="secondary">· SNR ${o.toFixed(1)} dB</span>`:W}
        </div>
        <meshcore-stat-bar
          .value=${t}
          .min=${-130}
    ...
    `}_renderRadioActivityTile(){const e=this._findByMetric("tx_airtime_util"),t=this._findByMetric("rx_airtime_util");if(!e&&!t)return W;const i=e?this._readNumber(e.entity_id):0,o=t?this._readNumber(t.entity_id):0,r=Number.isFinite(i)?Math.max(0,i):0,s=Number.isFinite(o)?Math.max(0,o):0,a=Math.max(0,100-r-s),n=st("tx_airtime_util",r).band,l=st("rx_airtime_util",s).band,d=this._worseBand(n,l),c=[{value:r,label:`TX ${r.toFixed(1)}%`,kind:"tx"},{value:s,label:`RX ${s.toFixed(1)}%`,kind:"rx"},{value:a,label:`Idle ${a.toFixed(1)}%`,kind:"idle"}],p=r+s;return K`
      <div class="hero-tile"
        ...
        <div class="ra-bar-wrap">
          ...
          <div class="ra-legend">
            ${e?K`<span class="ra-legend-item" @click=${t=>{t.stopPropagation(),e&&this._fireMoreInfo(e.entity_id)}}>
                  <span class="legend-swatch tx"></span>TX ${r.toFixed(1)}%
                </span>`:K`<span class="ra-legend-item">
                  <span class="legend-swatch tx"></span>TX ${r.toFixed(1)}%
                </span>`}
            ${t?K`<span class="ra-legend-item" @click=${e=>{e.stopPropagation(),t&&this._fireMoreInfo(t.entity_id)}}>
    ...
    `}_renderMessagesReceivedTile(e){const t=this._findEntityIdMatching("nb_recv"),i=this._findEntityIdMatching("recv_flood"),o=this._findEntityIdMatching("recv_direct"),r=this._findEntityIdMatching("flood_dups"),s=this._findEntityIdMatching("direct_dups");if(!t||!i&&!o)return W;const a=this._readNumber(t.entity_id),n=i?this._readNumber(i.entity_id):0,l=o?this._readNumber(o.entity_id):0,d=[{value:n,label:`Flood ${n}`,kind:"flood"},{value:l,label:`Direct ${l}`,kind:"direct"}],c=r?this._readNumber(r.entity_id):0,p=s?this._readNumber(s.entity_id):0,h=(Number.isFinite(c)?c:0)+(Number.isFinite(p)?p:0),g=a>0?h/a*100:0;e.add(t.entity_id),i&&e.add(i.entity_id),o&&e.add(o.entity_id),r&&e.add(r.entity_id),s&&e.add(s.entity_id);const u=this._findEntityIdMatching("recv_errors"),m=u?this._readNumber(u.entity_id):NaN,v=Number.isFinite(m)?m:0,f=a+v,y=f>0?v/f*100:0;return u&&e.add(u.entity_id),K`
      <div class="hero-tile" @click=${()=>this._fireMoreInfo(t.entity_id)}>
        <div class="hero-tile-head">
        ...
        ${h>0?K`<div class="dup-line"
                      title="Duplicate receptions: ${h} — ${g.toFixed(1)}% of received messages">
              <div class="dup-line-fill" style="width:${Math.min(100,g).toFixed(1)}%"></div>
            </div>`:W}
        <div class="msg-legend">
          <span><span class="msg-swatch flood"></span>Flood ${n}</span>
          <span><span class="msg-swatch direct"></span>Direct ${l}</span>
          ${v>0?K`<span><span class="msg-swatch error"></span>Error ${v}</span>`:W}
          ${h>0?K`<span><span class="msg-swatch dup"></span>Dup ${h}</span>`:W}
        </div>
      </div>
    `}_renderRequestsTile(e){const t=this._findEntityIdMatching("request_succ"),i=this._findEntityIdMatching("request_fail");if(!t||!i)return W;const o=this._readNumber(t.entity_id),r=this._readNumber(i.entity_id),s=o+r,a=s>0?o/s*100:0,n=s>=50?st("request_success_rate",a):{band:"info",fillPct:0,tooltip:""},l=[{value:o,label:`OK ${o}`,kind:"success"},{value:r,label:`Fail ${r}`,kind:"failure"}];return e.add(t.entity_id),e.add(i.entity_id),K`
      <div class="hero-tile" @click=${()=>this._fireMoreInfo(t.entity_id)}>
        <div class="hero-tile-head">
        ...
        <div class="hero-tile-value">
          ...
          ${s>0?K`<span class="secondary">· ${s} attempt${1===s?"":"s"}</span>`:W}
        </div>
        <meshcore-stacked-bar
          .segments=${l}
          .legend=${"inline"}>
    ...
    `}_formatCount(e){return Number.isFinite(e)?Math.round(e).toLocaleString():"—"}_renderLocationTile(){const e=this._findEntityIdMatching("latitude"),t=this._findEntityIdMatching("longitude");let i=e?this._readNumber(e.entity_id):NaN,o=t?this._readNumber(t.entity_id):NaN,r="entity";!Number.isFinite(i)&&Number.isFinite(this.fallbackLatitude)&&(i=this.fallbackLatitude,r="fallback"),!Number.isFinite(o)&&Number.isFinite(this.fallbackLongitude)&&(o=this.fallbackLongitude,r="fallback");const s=Number.isFinite(i)&&Number.isFinite(o)&&(0!==i||0!==o);if(!s)return W;let a=null;if("entity"===r&&e){const t=this.hass?.states[e.entity_id]?.last_updated;if(t){const e=new Date(t);Number.isNaN(e.getTime())||(a=e)}}else"fallback"===r&&Number.isFinite(this.fallbackUpdated)&&(a=new Date(1e3*this.fallbackUpdated));const n=s&&a?this._formatRelativeTime(a):"";return K`
      <div class="hero-tile" @click=${()=>{e&&this._fireMoreInfo(e.entity_id)}}>
        <div class="hero-tile-head">
          <span>Location${"fallback"===r?K`<span style="opacity:0.55;text-transform:none;letter-spacing:0;font-size:10px;margin-left:4px;">via contact</span>`:W}</span>
        </div>
        <div class="hero-tile-value">
          ${s?K`<span class="coord-pair">
                ${i.toFixed(4)}, ${o.toFixed(4)}
              </span>`:K`<span class="primary">—</span>`}
        </div>
        ${n?K`<div class="loc-updated">Updated ${n}</div>`:W}
      </div>
    `}_formatRelativeTime(e){const t=(Date.now()-e.getTime())/1e3;return!Number.isFinite(t)||t<0||t<60?"just now":t<3600?`${Math.floor(t/60)} min ago`:t<86400?`${Math.floor(t/3600)} h ago`:`${Math.floor(t/86400)} d ago`}_renderCompanionRadioActivityTile(){const e=this._findEntityIdMatching("tx_airtime"),t=this._findEntityIdMatching("rx_airtime"),i=this._findByMetric("uptime_hours");if(!e&&!t||!i)return W;const o=this._readUptimeMinutes(i);if(!Number.isFinite(o)||o<=0)return W;const r=e?this._readNumber(e.entity_id):0,s=t?this._readNumber(t.entity_id):0;if(!Number.isFinite(r)&&!Number.isFinite(s))return W;const a=e=>Number.isFinite(e)?Math.min(100,Math.max(0,e/o*100)):0,n=a(r),l=a(s),d=Math.max(0,100-n-l),c=st("tx_airtime_util",n).band,p=st("rx_airtime_util",l).band,h=this._worseBand(c,p),g=[{value:n,label:`TX ${n.toFixed(1)}%`,kind:"tx"},{value:l,label:`RX ${l.toFixed(1)}%`,kind:"rx"},{value:d,label:`Idle ${d.toFixed(1)}%`,kind:"idle"}],u=n+l;return K`
      <div class="hero-tile"
           @click=${()=>e&&this._fireMoreInfo(e.entity_id)}>
        <div class="hero-tile-head">
        ...
        <div class="hero-tile-value">
          <span class="primary">${u.toFixed(1)}<span class="unit">%</span></span>
        </div>
        <div class="ra-bar-wrap">
          <meshcore-stacked-bar
            .segments=${g}
          ...
          <div class="ra-legend">
            ...
            ${t?K`<span class="ra-legend-item" @click=${e=>{e.stopPropagation(),t&&this._fireMoreInfo(t.entity_id)}}>
                  <span class="legend-swatch rx"></span>RX ${l.toFixed(1)}%
                </span>`:K`<span class="ra-legend-item">
                  <span class="legend-swatch rx"></span>RX ${l.toFixed(1)}%
                </span>`}
            <span class="ra-legend-item">
              <span class="legend-swatch idle"></span>Idle ${d.toFixed(1)}%
            </span>
          </div>
        </div>
      </div>
    `}_readUptimeMinutes(e){const t=this._readNumber(e.entity_id);if(!Number.isFinite(t))return NaN;switch(this.hass?.states[e.entity_id]?.attributes?.unit_of_measurement??""){case"d":return 1440*t;case"h":return 60*t;case"min":return t;default:return t/60}}_buildGroups(e){const t={"Radio · live":[],"Radio · configuration":[],Status:[],Identity:[]};for(const i of this.entities)e.has(i.entity_id)||this._isHeroDuplicate(i)||t[this._groupOf(i)].push(this._renderRow(i));const i="companion"===this.device?.type,o=["Radio · configuration","Identity"];return Object.entries(t).filter(([e,t])=>!(0===t.length||i&&o.includes(e))).map(([e,t])=>({name:e,rows:t}))}_isHeroDuplicate(e){return"battery_pct"===e.metricKey||2===e.sortOrder||"snr"===e.metricKey||"rssi"===e.metricKey||"uptime_hours"===e.metricKey||"tx_airtime_util"===e.metricKey||"rx_airtime_util"===e.metricKey||"Airtime"===e.label||"RX Airtime"===e.label}_groupOf(e){const t=e.entity_id,i=e.sortOrder;return e.booleanProblem||2===i?"Status":6===i?"Radio · configuration":4===i||5===i||9===i||10===i||11===i||12===i||t.includes("noise_floor")||t.includes("tx_queue")?"Radio · live":t.includes("frequency")||t.includes("bandwidth")||t.includes("spreading_factor")||t.includes("rate_limiter")?"Radio · configuration":t.includes("hop_count")||t.includes("out_path")||t.includes("last_seen")||t.includes("last_advert")||3===i||8===i||7===i?"Status":"Identity"}_renderGroup(e){return K`
      ...
      ${e.rows}
    `}_renderRow(e){if(e.booleanProblem){const t=this.hass?.states[e.entity_id]?.state,i=void 0===t||"unknown"===t||"unavailable"===t,o="on"===t,r=i?"info":o?"bad":"good";return K`
        <div class="sensor-item"
             @click=${()=>this._fireMoreInfo(e.entity_id)}
             @contextmenu=${t=>this._fireContextMenu(t,e)}
             ${et(()=>this._fireContextMenu(void 0,e))}>
      ...
      <div class="sensor-item"
        ...
        <span class="si-value">
          ${l}${o?K`<span class="unit">${o}</span>`:W}
        </span>
        <span class="si-bar">
          ${r&&e.metricKey?K`<meshcore-stat-bar
                .value=${r.fillPct}
                .min=${0}
                .max=${100}
                .band=${s}>
  ...
  `,e([ue({type:Object})],pt.prototype,"hass",void 0),e([ue({type:Object})],pt.prototype,"device",void 0),e([ue({type:Array})],pt.prototype,"entities",void 0),e([ue({type:Number})],pt.prototype,"hiddenCount",void 0),e([ue({type:Number})],pt.prototype,"fallbackLatitude",void 0),e([ue({type:Number})],pt.prototype,"fallbackLongitude",void 0),e([ue({type:Number})],pt.prototype,"fallbackUpdated",void 0),e([me()],pt.prototype,"_rateHistory",void 0),pt=e([pe("meshcore-node-summary")],pt);let ht=class extends de{constructor(){super(...arguments),this.data=[],this.neighbors=[],this.width=600,this.height=200,this.timeRange=24,this.COLORS=["#FF6B6B","#4ECDC4","#FFE66D","#95E1D3","#C7CEEA","#FF8B94","#B5EAD7","#FFB7B2"]}render(){if(!this.data||0===this.data.length||0===this.neighbors.length)return K`
        <div class="chart-container">
          <div class="empty-state">No data available</div>
        </div>
      `;const e=this._renderChart();return K`
      <div class="chart-container">
        ${e}
        <div class="legend">
          ${this.neighbors.map((e,t)=>{const i=this.COLORS[t%this.COLORS.length];return K`
    ...
    `}_renderChart(){const e=50,t=this.width-100,i=this.height-100;let o=1/0,r=-1/0;this.data.forEach(e=>{Object.values(e.values).forEach(e=>{"number"==typeof e&&(o=Math.min(o,e),r=Math.max(r,e))})}),isFinite(o)&&isFinite(r)||(o=-10,r=20);const s=r-o,a=o-.1*s,n=r+.1*s,l=t=>this.height-e-(t-a)/(n-a)*i,d=60*this.timeRange*60*1e3,c=Date.now(),p=c-d,h=i=>e+(i-p)/d*t,g=[];for(let t=0;t<=5;t++){const i=a+t/5*(n-a),o=l(i);g.push(j`
        ...
        `)}const u=[];for(let t=0;t<=5;t++){const i=p+t/5*d,o=h(i),r=this._formatTimeLabel(i,c);u.push(j`
          <text x="${o}" y="${this.height-e+16}" font-size="10" text-anchor="middle"
            fill="var(--secondary-text-color, #727272)">${r}</text>
        `)}const m=this.neighbors.map((e,t)=>{const i=this.COLORS[t%this.COLORS.length],o=[];return this.data.forEach(t=>{const i=t.values[e];if("number"==typeof i&&isFinite(i)){const e=h(t.timestamp),r=l(i);o.push(`${e},${r}`)}}),0===o.length?j``:j`
    ...
    `}_formatTimeLabel(e,t){const i=(t-e)/36e5;return i>=24?`${Math.round(i)}h ago`:0===i?"Now":`${Math.round(i)}h`}};ht.styles=a`
    :host {
      display: block;
      width: 100%;
  ...
  `,e([ue({type:Array})],ht.prototype,"data",void 0),e([ue({type:Array})],ht.prototype,"neighbors",void 0),e([ue({type:Number})],ht.prototype,"width",void 0),e([ue({type:Number})],ht.prototype,"height",void 0),e([ue({type:Number})],ht.prototype,"timeRange",void 0),ht=e([pe("meshcore-snr-chart")],ht);let gt=class extends de{constructor(){super(),this.open=!1,this.title="Confirm",this.message="",this.confirmLabel="Confirm",this.cancelLabel="Cancel",this.dangerous=!1,this._typedValue="",We(this,{isOpen:()=>this.open,onEscape:()=>this._onCancel()})}render(){if(!this.open)return;const e=this.requireTyped&&this._typedValue!==this.requireTyped;return K`
        ...
        <div
          ...
          <div class="dialog-header">
            <div style="flex: 1;">
              ...
              ${this.targetPrefix?K`<div style="font-size: 12px; color: var(--secondary-text-color); margin-top: 4px;">
          ...
          <div class="dialog-body">
            ...
            <div class="form-group">
              ...
              <select
                ...
                ${Array.from(e.entries()).map(([e,t])=>K`<optgroup label=${e}>
                      ${t.map(e=>K`<option value=${e.name}>
            ...
            <!-- Command Details -->
            ${this._selectedCommand?K`
                  <div class="command-description">
                    <strong>${this._selectedCommand.name}</strong><br />
                    ${this._selectedCommand.description}
                  </div>

                  ${this._selectedCommand.dangerous?K`<div class="danger-warning">
                  ...
                  <!-- Parameters -->
                  ${this._selectedCommand.params&&this._selectedCommand.params.length>0?K`
                  ...
                  <!-- Expected Response -->
                  ${this._selectedCommand.responseFormat?K`<div style="margin-top: 12px; font-size: 12px; color: var(--secondary-text-color); font-style: italic;">
            ...
            ${!this.isLocal&&this._deviceResponses.length>0?K`
                  <div class="form-group" style="margin-top: 16px;">
                    <label class="form-label">Responses from device</label>
                    <div class="device-response-feed">
                      ${this._deviceResponses.map(e=>K`<div class="device-response-row">
                          <span class="drr-time">${new Date(e.ts).toLocaleTimeString()}</span><span class="drr-text">${e.text}</span>${void 0!==e.snr?K`<span class="drr-snr"> · SNR ${e.snr}</span>`:""}
                        </div>`)}
                    </div>
                  </div>
                `:""}
    ...
    `}_renderParamInput(e){const t=this._paramValues[e.name]??e.default??"",i=e.label??e.name;switch(e.type){case"boolean":return K`
          <div class="form-group">
            <label class="form-toggle">
              <input
                type="checkbox"
            ...
            ${e.description?K`<div class="form-description">${e.description}</div>`:""}
          </div>
        `;case"select":{const o=e.selectOptions?e.selectOptions:(e.options||[]).map(e=>({label:e,value:e}));return K`
          <div class="form-group">
            ...
            <select
              ...
              ${o.map(e=>K`<option value=${String(e.value)} ?selected=${String(t)===String(e.value)}>${e.label}</option>`)}
            </select>
            ${e.description?K`<div class="form-description">${e.description}</div>`:""}
          </div>
        `}case"bitmask":return K`
          <fieldset class="form-group">
            <legend class="form-label">${i}</legend>
            ${(e.bits||[]).map(t=>{const i=Number(this._paramValues[e.name]??e.default??0);return K`
                <label class="form-toggle">
                  <input
                    type="checkbox"
    ...
    `],$t._FRIENDLY_LABELS={adv_type:"Device Type",tx_power:"TX Power (dBm)",max_tx_power:"Max TX Power (dBm)",public_key:"Public Key",adv_lat:"Latitude",adv_lon:"Longitude",multi_acks:"Multi-Acks",adv_loc_policy:"Location Ad Policy",telemetry_mode_env:"Telemetry: Environment",telemetry_mode_loc:"Telemetry: Location",telemetry_mode_base:"Telemetry: Base",manual_add_contacts:"Manual Add Contacts",radio_freq:"Frequency (MHz)",radio_bw:"Bandwidth (kHz)",radio_sf:"Spreading Factor",radio_cr:"Coding Rate",name:"Name",path_hash_mode:"Path Hash Mode",firmware_ver:"Firmware Version",board_type:"Board Type",suggested_timeout:"Suggested Timeout (ms)",capabilities:"Capabilities",voltage:"Voltage (mV)",percentage:"Battery (%)",uptime:"Uptime (s)",temperature:"Temperature",max_hops:"Max Hops (0 = unlimited)",config:"Auto-Add Config"},$t._VALUE_FORMATTERS={adv_loc_policy:e=>bt(e,mt),path_hash_mode:e=>bt(e,vt),telemetry_mode_env:e=>bt(e,ft),telemetry_mode_loc:e=>bt(e,ft),telemetry_mode_base:e=>bt(e,ft),manual_add_contacts:e=>{if(!0===e)return"Manual Mode";if(!1===e)return"Auto-Add Enabled";const t=ut(e);return void 0===t?`Unknown (${e})`:t?"Manual Mode":"Auto-Add Enabled"},multi_acks:e=>{const t=ut(e);return void 0===t?`Unknown (${e})`:t?"Yes":"No"},adv_lat:e=>{const t=ut(e);return void 0===t?`${e}`:`${t.toFixed(6)}°`},adv_lon:e=>{const t=ut(e);return void 0===t?`${e}`:`${t.toFixed(6)}°`},config:e=>{const t=ut(e);return void 0===t?`Unknown (${e})`:function(e,t){const i={};for(const o of t)i[o.label]=(e&o.value)===o.value;return i}(t,yt)}},e([ue({type:Boolean})],$t.prototype,"open",void 0),e([ue({type:Object})],$t.prototype,"hass",void 0),e([ue({type:String})],$t.prototype,"entryId",void 0),e([ue({type:String})],$t.prototype,"targetPrefix",void 0),e([ue({type:Boolean})],$t.prototype,"isLocal",void 0),e([ue({type:Boolean})],$t.prototype,"narrow",void 0),e([ue({type:String})],$t.prototype,"nodeName",void 0),e([me()],$t.prototype,"_selectedCommand",void 0),e([me()],$t.prototype,"_paramValues",void 0),e([me()],$t.prototype,"_response",void 0),e([me()],$t.prototype,"_executing",void 0),e([me()],$t.prototype,"_error",void 0),e([me()],$t.prototype,"_deviceResponses",void 0),$t=wt=e([pe("meshcore-command-dialog")],$t);let St=class extends de{constructor(){super(),this.narrow=!1,this._managedDevices={repeaters:[],clients:[]},this._contactsByPrefix={},this._loading=!0,this._error=null,this._confirmAction=null,this._confirmDialogOpen=!1,this._commandDialogOpen=!1,this._commandDialogTarget="",this._commandDialogIsLocal=!1,this._statusMessage=null,this._statusMessageTimeout=null,this._deviceEntities={},this._meshcoreDeviceMap={},this._entityRegistryLoaded=!1,this._hiddenSensors={},this._contextMenu=null,this._overlayPointerStarted=!1,this._settingsDeviceKey=null,this._hiddenSensorsModalKey=null,this._neighborContextMenu=null,this._neighborData={},We(this,{isOpen:()=>null!==this._contextMenu,onEscape:()=>this._dismissContextMenu(),getScope:()=>this.shadowRoot?.querySelector('[data-a11y="tile-context"]')}),We(this,{isOpen:()=>null!==this._neighborContextMenu,onEscape:()=>this._dismissNeighborContextMenu(),getScope:()=>this.shadowRoot?.querySelector('[data-a11y="neighbor-context"]')}),We(this,{isOpen:()=>null!==this._settingsDeviceKey,onEscape:()=>this._closeSettingsModal(),getScope:()=>this.shadowRoot?.querySelector('[data-a11y="device-settings"]')}),We(this,{isOpen:()=>null!==this._hiddenSensorsModalKey,onEscape:()=>this._closeHiddenSensorsModal(),getScope:()=>this.shadowRoot?.querySelector('[data-a11y="hidden-sensors"]')})}connectedCallback(){super.connectedCallback(),this._loadHiddenSensors(),this._loadManagedDevices()}disconnectedCallback(){super.disconnectedCallback(),null!==this._statusMessageTimeout&&(clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=null)}updated(e){e.has("config")&&this._loadManagedDevices(),e.has("hass")&&this.hass&&!this._entityRegistryLoaded&&this._loadEntityRegistry()}render(){return this.hass?K`
      <div class="devices-layout">
        <div class="content-area">
          ${this._error?K`<div class="error-state"><svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/></svg> ${this._error}</div>`:W}

          ${this._loading?K`<div class="loading-state"><div class="loading-spinner"></div> Loading devices...</div>`:K`
                ...
                ${0===this._managedDevices.repeaters.length&&0===this._managedDevices.clients.length?K`
                      <div class="empty-state">
      ...
      <!-- Settings Modal -->
      ${this._settingsDeviceKey?(()=>{const e=this._getSettingsDeviceContext();return e?K`
      ...
      <!-- Status Toast -->
      ${this._statusMessage?K`<div class="status-toast ${this._statusMessage.type}">${"success"===this._statusMessage.type?"✓ ":"✗ "}${this._statusMessage.text}</div>`:W}
    `:K`<div class="content-area"><div class="loading-state"><div class="loading-spinner"></div> Initializing...</div></div>`}_renderDeviceSections(e,t){return e.map(e=>this._renderDeviceSection(e,t))}_renderDeviceSection(e,t){let i="unknown",o="Unknown";if(e.status_entity_id&&this.hass?.states[e.status_entity_id]){const t=this.hass.states[e.status_entity_id].state;"on"===t?(i="online",o="Online"):"off"===t&&(i="offline",o="Offline")}else e.status&&(i="online"===e.status?"online":"offline"===e.status?"offline":"unknown",o="online"===e.status?"Online":"offline"===e.status?"Offline":"Unknown");const r="online"===i,s=this._getManagedDeviceKey(e,t),a=this._getDeviceEntities(e,t),n=(this._hiddenSensors[s]||[]).length,l="repeater"===t&&e.neighbors_enabled,d=this._neighborData[e.pubkey_prefix],c=a.find(e=>"uptime_hours"===e.metricKey),p=r&&c?this._formatUptimeFromEntity(c.entity_id):"",h=this._contactsByPrefix[e.pubkey_prefix?.toLowerCase()],g=h?.adv_lat,u=h?.adv_lon,m=h?.last_advert,v="number"==typeof g?g:NaN,f="number"==typeof u?u:NaN,y=Number.isFinite(v)&&Number.isFinite(f)&&(0!==v||0!==f);return l&&!d&&this._loadNeighbors(e),K`
      <div class="device-section" @tile-context-menu=${e=>this._onTileContextMenu(e,s)}>
        <div class="section-header">
          <div class="section-title">
            <div class="section-icon ${t}">
              ${"repeater"===t?K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`:K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`}
            </div>
            <div>
              <div class="device-name">${e.name}</div>
              <div class="device-meta">
                <span>${"repeater"===t?"Repeater":"Client"}</span>
                ${e.firmware_version?K`<span>Firmware: v${e.firmware_version.match(/(\d+\.\d+\.\d+)/)?.[1]??e.firmware_version}</span>`:W}
                <span>Key: ${e.pubkey_prefix}</span>
                ${y?K`<span>Loc: ${v.toFixed(4)}, ${f.toFixed(4)}</span>`:W}
              </div>
            </div>
          </div>
        ...
        ${l?this._renderInlineNeighbors(e,d):W}
    ...
    `}_renderInlineNeighbors(e,t){return!t||t.loading?K`
          ...
          <tbody>
            ${t.neighbors.map(t=>K`
              <tr @contextmenu=${i=>this._onNeighborRightClick(i,t,e.pubkey_prefix)}
                  ${et(()=>this._onNeighborRightClick(new MouseEvent("contextmenu"),t,e.pubkey_prefix))}>
    ...
    `}async _loadEntityRegistry(){if(this.hass&&!this._entityRegistryLoaded){this._entityRegistryLoaded=!0;try{const{meshcoreDeviceMap:e,deviceEntities:t}=await Ct(this.hass);this._meshcoreDeviceMap=e,this._deviceEntities=t}catch(e){console.error("Failed to load entity registry:",e)}}}_getDeviceEntities(e,t){if(!this.hass||!this.config)return[];const i=this._getManagedDeviceKey(e,t),o=new Set(this._hiddenSensors[i]||[]),r=this.selectedDevice?.entry_id||"",s=e.pubkey_prefix||"",a=`${r}_${t}_${s}`,n=this._meshcoreDeviceMap[a];if(n&&this._deviceEntities[n])return this._deviceEntities[n].filter(e=>!o.has(e.entity_id));for(const[e,i]of Object.entries(this._meshcoreDeviceMap))if(e.includes(s)&&e.includes(t)&&this._deviceEntities[i])return this._deviceEntities[i].filter(e=>!o.has(e.entity_id));const l=s.substring(0,6).toLowerCase();if(!l)return[];const d=[];for(const e of Object.values(this._deviceEntities))for(const t of e)t.entity_id.toLowerCase().includes(l)&&!o.has(t.entity_id)&&d.push(t);return d.sort((e,t)=>e.sortOrder-t.sortOrder)}async _loadNeighbors(e){if(this.hass){this._neighborData={...this._neighborData,[e.pubkey_prefix]:{neighbors:[],chartData:[],loading:!0,loaded:!1}};try{const t=await async function(e,t,i){try{const o={type:"meshcore_chat/get_neighbors",target_prefix:t};return i&&(o.entry_id=i),(await e.callWS(o)).neighbors||[]}catch{return[]}}(this.hass,e.pubkey_prefix,this.config?.entry_id);let i=[];t.length>0&&(i=await this._fetchSNRHistory(t)),this._neighborData={...this._neighborData,[e.pubkey_prefix]:{neighbors:t,chartData:i,loading:!1,loaded:!0}}}catch(t){console.error(`Failed to load neighbors for ${e.name}:`,t),this._neighborData={...this._neighborData,[e.pubkey_prefix]:{neighbors:[],chartData:[],loading:!1,loaded:!0}}}}}async _fetchSNRHistory(e){if(!this.hass)return[];try{const t=e.filter(e=>e.entity_ids?.snr).map(e=>e.entity_ids.snr);if(0===t.length)return[];const i=await this.hass.callWS({type:"recorder/statistics_during_period",start_time:new Date(Date.now()-864e5).toISOString(),end_time:(new Date).toISOString(),statistic_ids:t,period:"hour"}),o={};return Object.entries(i).forEach(([t,i])=>{const r=e.find(e=>e.entity_ids?.snr===t);r&&Array.isArray(i)&&i.forEach(e=>{if(e.start&&null!=e.mean){const t=new Date(e.start).getTime();o[t]||(o[t]={}),o[t][r.pubkey_prefix]=e.mean}})}),Object.entries(o).map(([e,t])=>({timestamp:parseInt(e,10),values:t})).sort((e,t)=>e.timestamp-t.timestamp)}catch{return[]}}async _loadManagedDevices(){if(this.hass)try{this._loading=!0,this._error=null;const e=await async function(e,t){try{const i={type:"meshcore_chat/get_managed_devices"};t&&(i.entry_id=t);const o=await e.callWS(i);return{repeaters:o.repeaters||[],clients:o.clients||[]}}catch{return{repeaters:[],clients:[]}}}(this.hass,this.config?.entry_id);this._managedDevices=e,this._loadContacts()}catch(e){this._error=`Failed to load devices: ${String(e)}`}finally{this._loading=!1}}async _loadContacts(){if(this.hass)try{const e=this.selectedDevice?.entry_id||this.config?.entry_id,t=await $e(this.hass,e),i={};for(const e of t)e.pubkey_prefix&&(i[e.pubkey_prefix.toLowerCase()]=e);this._contactsByPrefix=i}catch{}}async _executeRemoteAction(e,t){if(this.hass)try{const i=await Ae(this.hass,e.pubkey_prefix,t,this.config?.entry_id);i.success?this._showStatusMessage(`${e.name}: ${t} → ${i.response||"OK"}`,"success"):this._showStatusMessage(`${e.name}: ${t} failed — ${i.response||"error"}`,"error")}catch(i){this._showStatusMessage(`${e.name}: ${t} failed — ${String(i)}`,"error")}}_fireMoreInfo(e){const t=new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}_formatUptimeFromEntity(e){const t=this.hass?.states[e];if(!t||"unavailable"===t.state||"unknown"===t.state)return"";const i=parseFloat(t.state);if(!Number.isFinite(i))return"";let o;switch(t.attributes?.unit_of_measurement??"s"){case"d":o=86400*i;break;case"h":o=3600*i;break;case"min":o=60*i;break;default:o=i}if(o<60)return`${Math.floor(o)}s`;if(o<3600)return`${Math.floor(o/60)}m`;if(o<86400){const e=Math.floor(o/3600),t=Math.floor(o%3600/60);return t>0?`${e}h ${t}m`:`${e}h`}const r=Math.floor(o/86400),s=Math.floor(o%86400/3600);return s>0?`${r}d ${s}h`:`${r}d`}_confirmActionDialog(e,t,i){this._confirmAction={title:e,message:t,onConfirm:i},this._confirmDialogOpen=!0}async _onConfirmAction(){if(this._confirmDialogOpen=!1,this._confirmAction)try{await this._confirmAction.onConfirm()}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}this._confirmAction=null}_onConfirmCancel(){this._confirmDialogOpen=!1,this._confirmAction=null}_openCommandDialog(e,t){this._commandDialogTarget=e.pubkey_prefix,this._commandDialogIsLocal=t,this._commandDialogOpen=!0}_onCommandDialogClose(){this._commandDialogOpen=!1,this._commandDialogTarget="",this._commandDialogIsLocal=!1}_getManagedDeviceKey(e,t){return`${this.selectedDevice?.entry_id||""}_${t}_${e.pubkey_prefix}`}_loadHiddenSensors(){try{const e=localStorage.getItem("meshcore-hidden-sensors");e&&(this._hiddenSensors=JSON.parse(e))}catch{this._hiddenSensors={}}}_saveHiddenSensors(){try{localStorage.setItem("meshcore-hidden-sensors",JSON.stringify(this._hiddenSensors))}catch{}}_hideSensor(e,t){const i=this._hiddenSensors[e]||[];i.includes(t)||(this._hiddenSensors={...this._hiddenSensors,[e]:[...i,t]},this._saveHiddenSensors())}_unhideSensor(e,t){const i=this._hiddenSensors[e]||[];if(this._hiddenSensors={...this._hiddenSensors,[e]:i.filter(e=>e!==t)},0===this._hiddenSensors[e].length){const t={...this._hiddenSensors};delete t[e],this._hiddenSensors=t}this._saveHiddenSensors()}_unhideAllSensors(e){const t={...this._hiddenSensors};delete t[e],this._hiddenSensors=t,this._saveHiddenSensors()}_onTileContextMenu(e,t){const{entityId:i,label:o}=e.detail;this._contextMenu={entityId:i,label:o,deviceKey:t},this._overlayPointerStarted=!1}_onOverlayPointerDown(){this._overlayPointerStarted=!0}_dismissContextMenu(){this._overlayPointerStarted=!1,this._contextMenu=null}_closeContextMenu(){this._overlayPointerStarted&&this._dismissContextMenu()}_hideSensorFromContext(){this._contextMenu&&(this._hideSensor(this._contextMenu.deviceKey,this._contextMenu.entityId),this._showStatusMessage(`Hidden: ${this._contextMenu.label}`,"success"),this._contextMenu=null)}_onNeighborRightClick(e,t,i){e.preventDefault(),this._neighborContextMenu={name:t.name||t.pubkey_prefix,neighborPubkey:t.pubkey_prefix,repeaterPubkey:i},this._overlayPointerStarted=!1}_dismissNeighborContextMenu(){this._overlayPointerStarted=!1,this._neighborContextMenu=null}_closeNeighborContextMenu(){this._overlayPointerStarted&&this._dismissNeighborContextMenu()}_removeNeighborFromContext(){if(!this._neighborContextMenu)return;const{name:e,neighborPubkey:t,repeaterPubkey:i}=this._neighborContextMenu;this._neighborContextMenu=null,this._confirmActionDialog(`Remove neighbor ${e}?`,"This will remove the neighbor from the repeater and delete its sensors from HA. This cannot be undone.",()=>this._executeRemoveNeighbor(i,t,e))}_openNeighborMoreInfo(e,t,i){const o=e.substring(0,10).toLowerCase(),r=t.substring(0,6).toLowerCase(),s="snr"===i?`sensor.meshcore_${o}_neighbor_${r}`:`sensor.meshcore_${o}_neighbor_${r}_seen`;this.hass?.states[s]&&this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:s},bubbles:!0,composed:!0}))}async _executeRemoveNeighbor(e,t,i){if(this.hass)try{const o=await this.hass.callWS({type:"meshcore_chat/remove_neighbor",entry_id:this.config?.entry_id,target_prefix:e,neighbor_pubkey:t}),r=o?.entities_removed??0;this._showStatusMessage(`Removed ${i} (${r} sensors deleted)`,"success");const s=this._managedDevices.repeaters.find(t=>t.pubkey_prefix===e);s&&await this._loadNeighbors(s)}catch(e){this._showStatusMessage(`Failed to remove ${i}: ${e.message||e}`,"error")}}_getSettingsDeviceContext(){const e=this._settingsDeviceKey;if(!e)return null;const t=[...this._managedDevices.repeaters.map(e=>({device:e,type:"repeater"})),...this._managedDevices.clients.map(e=>({device:e,type:"client"}))];for(const{device:i,type:o}of t)if(this._getManagedDeviceKey(i,o)===e){let e=!1;return e=i.status_entity_id&&this.hass?.states[i.status_entity_id]?"on"===this.hass.states[i.status_entity_id].state:"online"===i.status,{device:i,type:o,name:i.name,isOnline:e}}return null}_closeSettingsModal(){this._settingsDeviceKey=null}_openHiddenSensorsList(){this._hiddenSensorsModalKey=this._settingsDeviceKey,this._settingsDeviceKey=null}_renderHiddenSensorsModal(){const e=this._hiddenSensorsModalKey,t=(this._hiddenSensors[e]||[]).map(e=>{let t=e;for(const i of Object.values(this._deviceEntities)){const o=i.find(t=>t.entity_id===e);if(o){t=o.label;break}}return{entityId:e,label:t}});return K`
      <div class="modal-overlay" @click=${this._closeHiddenSensorsModal}>
        <div class="modal-card" data-a11y="hidden-sensors"
          ...
          <div class="modal-body">
            ${0===t.length?K`<div class="empty-hidden">No hidden sensors</div>`:t.map(t=>K`
    ...
    `],e([ue({type:Object})],St.prototype,"hass",void 0),e([ue({type:Object})],St.prototype,"config",void 0),e([ue({type:Boolean})],St.prototype,"narrow",void 0),e([ue({type:Object})],St.prototype,"selectedDevice",void 0),e([me()],St.prototype,"_managedDevices",void 0),e([me()],St.prototype,"_contactsByPrefix",void 0),e([me()],St.prototype,"_loading",void 0),e([me()],St.prototype,"_error",void 0),e([me()],St.prototype,"_confirmAction",void 0),e([me()],St.prototype,"_confirmDialogOpen",void 0),e([me()],St.prototype,"_commandDialogOpen",void 0),e([me()],St.prototype,"_commandDialogTarget",void 0),e([me()],St.prototype,"_commandDialogIsLocal",void 0),e([me()],St.prototype,"_statusMessage",void 0),e([me()],St.prototype,"_statusMessageTimeout",void 0),e([me()],St.prototype,"_deviceEntities",void 0),e([me()],St.prototype,"_meshcoreDeviceMap",void 0),e([me()],St.prototype,"_entityRegistryLoaded",void 0),e([me()],St.prototype,"_hiddenSensors",void 0),e([me()],St.prototype,"_contextMenu",void 0),e([me()],St.prototype,"_settingsDeviceKey",void 0),e([me()],St.prototype,"_hiddenSensorsModalKey",void 0),e([me()],St.prototype,"_neighborContextMenu",void 0),e([me()],St.prototype,"_neighborData",void 0),St=e([pe("meshcore-devices-page")],St);let Mt=class extends de{constructor(){super(...arguments),this.selected=!1}render(){if(!this.contact)return K``;const e=this.contact,t=this._getTypeClass(e.type),{label:i,cls:o}=this._getCategoryBadge(e);return K`
    ...
    `}_getCategoryBadge(e){return e.added_to_node?{label:"Added",cls:"added"}:{label:"Discovered",cls:"discovered"}}_getTypeClass(e){switch(e){case 1:return"client";case 2:return"repeater";case 3:return"room-server";case 4:return"sensor";default:return"unknown"}}_getTypeIcon(e){switch(e){case 0:case 1:default:return K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`;case 2:return K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`;case 3:return K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`;case 4:return K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`}}};Mt.styles=a`
    :host {
      display: block;
      height: 100%;
    }
  ...
  `,e([ue({type:Object})],Mt.prototype,"contact",void 0),e([ue({type:Boolean})],Mt.prototype,"selected",void 0),Mt=e([pe("meshcore-contact-card")],Mt);let At=class extends de{constructor(){super(...arguments),this.selected=!1}render(){if(!this.node)return K``;const e="adv_name"in this.node,t=e?2===this.node.type:"repeater"===this.node.type,i=e&&3===this.node.type,o=e?1===this.node.type:"client"===this.node.type,r=e&&4===this.node.type,s=e?this.node.adv_name:this.node.name,a=this.node.pubkey_prefix,n=e?this.node.last_advert:void 0;let l=K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`,d="Contact",c="";t?(l=K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`,d="Repeater",c="repeater"):i?(l=K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`,d="Room Server",c="room-server"):r?(l=K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`,d="Sensor",c="sensor"):o&&(l=K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`,d="Client",c="client");const p=e&&(0!==this.node.adv_lat||0!==this.node.adv_lon),h=n?new Date(1e3*n).toLocaleTimeString():"Unknown";return K`
      <div class=${this.selected?"node-card selected":"node-card"}>
        <div class="node-header">
          <div class=${`node-avatar ${c}`}>${l}</div>
          <div class="node-info">
            <div class="node-name">${s}</div>
            <div class="node-prefix">${a}</div>
            <div class=${`node-type-label ${c}`}>${d}</div>
          </div>
        </div>

        <div class="node-meta">
          ${n?K`<div class="meta-item"><span><svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" style="vertical-align: -2px;"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/></svg></span><span>${h}</span></div>`:K``}
          ${p?K`<div class="location-indicator"><svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" style="vertical-align: -2px; margin-right: 2px;"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>${this.node.adv_lat.toFixed(3)}, ${this.node.adv_lon.toFixed(3)}</div>`:K``}
          ${e&&this.node.out_path?K`<div class="route-info">Route: ${this.node.out_path.substring(0,12)}...</div>`:K``}
        </div>
    ...
    `}_dispatch(e){this.dispatchEvent(new CustomEvent(e,{detail:{node:this.node},bubbles:!0,composed:!0}))}};At.styles=a`
    :host { display: block; }
  ...
  `,e([ue({type:Object})],At.prototype,"node",void 0),e([ue({type:Boolean})],At.prototype,"selected",void 0),At=e([pe("meshcore-node-card")],At);let Dt=class extends de{constructor(){super(),this.open=!1,this.pendingAction=null,this._confirming=!1,this._confirmAction=null,We(this,{isOpen:()=>this.open,onEscape:()=>{this._confirming?(this._confirming=!1,this._confirmAction=null):this._close()}})}render(){if(!this.open||!this.node)return K``;const e="adv_name"in this.node,t=e?2===this.node.type:"repeater"===this.node.type,i=e&&3===this.node.type,o=e?1===this.node.type:"client"===this.node.type,r=e&&4===this.node.type,s=e?this.node.adv_name:this.node.name,a=this.node.pubkey_prefix;let n=K`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`,l="Contact",d="";return t?(n=K`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M12 5c-3.87 0-7 3.13-7 7h2c0-2.76 2.24-5 5-5s5 2.24 5 5h2c0-3.87-3.13-7-7-7zm0-4C5.93 1 1 5.93 1 12h2c0-4.97 4.03-9 9-9s9 4.03 9 9h2c0-6.07-4.93-11-11-11zm0 8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>`,l="Repeater",d="repeater"):i?(n=K`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H6l-2 2V4h16v12z"/></svg>`,l="Room Server",d="room-server"):r?(n=K`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg>`,l="Sensor",d="sensor"):o&&(n=K`<svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M17 1.01L7 1c-1.1 0-2 .9-2 2v18c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V3c0-1.1-.9-1.99-2-1.99zM17 19H7V5h10v14z"/></svg>`,l="Client",d="client"),K`
          ...
          <div class="dialog-content">
            ${this._confirming?K`
                  <div class="confirm-section">
                    ...
                    ${"remove-contact"===this._confirmAction?K`
                ...
                `:K`
                  <div class="section">
                    ...
                    <div class="quick-actions ${e?"":"full"}">
                      ${e&&this.node.added_to_node&&(o||i)?K`
                      ...
                      `:K``}
                      ${e&&this.node.added_to_node?K`<button class="action-btn warning"
                            ?disabled=${"remove-contact"===this.pendingAction}
                            @click=${()=>{this._confirming=!0,this._confirmAction="remove-contact"}}>${"remove-contact"===this.pendingAction?"Removing…":"Remove Contact"}</button>`:e?K`<button class="action-btn"
                            ?disabled=${"add-contact"===this.pendingAction}
                            @click=${()=>this._dispatchEvent("add-contact")}>${"add-contact"===this.pendingAction?K`Adding…`:K`<svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>Add Contact`}</button>`:K``}
                    </div>
                  </div>
                  ...
                  ${!e||0===this.node.adv_lat&&0===this.node.adv_lon?K``:K`
                        <div class="section">
    ...
    `}_close(){this.open=!1,this._confirming=!1,this._confirmAction=null,this.dispatchEvent(new CustomEvent("node-detail-closed",{bubbles:!0,composed:!0}))}_dispatchEvent(e){this.dispatchEvent(new CustomEvent(`node-${e}`,{detail:{node:this.node},bubbles:!0,composed:!0}))}_confirmAction_exec(){this._confirmAction&&this._dispatchEvent(this._confirmAction),this._close()}};Dt.styles=a`
    :host {
      display: contents;
    }
  ...
  `,e([ue({type:Object})],Dt.prototype,"node",void 0),e([ue({type:Boolean})],Dt.prototype,"open",void 0),e([ue({type:Object})],Dt.prototype,"hass",void 0),e([ue({type:String})],Dt.prototype,"pendingAction",void 0),e([me()],Dt.prototype,"_confirming",void 0),e([me()],Dt.prototype,"_confirmAction",void 0),Dt=e([pe("meshcore-node-detail-dialog")],Dt);const zt={clients:1,repeaters:2,room_servers:3,sensors:4},Rt={clients:"Clients",repeaters:"Repeaters",room_servers:"Room Servers",sensors:"Sensors"};let Ot=class extends de{constructor(){super(...arguments),this.contacts=[],this.channels=[],this.narrow=!1,this._viewportNarrow=!1,this._primaryFilter="all",this._typeFilter=null,this._searchQuery="",this._displayedContacts=[],this._totalCount=0,this._typeCounts={clients:0,repeaters:0,room_servers:0,sensors:0},this._l1Counts={all:0,added:0,discovered:0},this._loading=!1,this._nodeDetailDialogOpen=!1,this._pendingAction=null,this._sortBy="last_heard",this._onMediaChange=e=>{this._viewportNarrow=e.matches}}connectedCallback(){super.connectedCallback(),this._mediaQuery=window.matchMedia("(max-width: 870px)"),this._viewportNarrow=this._mediaQuery.matches,this._mediaQuery.addEventListener("change",this._onMediaChange),this._loadCounts(),this._loadPage(!0)}disconnectedCallback(){super.disconnectedCallback(),this._mediaQuery?.removeEventListener("change",this._onMediaChange),this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=void 0)}get _isNarrow(){return this.narrow||this._viewportNarrow}updated(e){super.updated(e),this._isNarrow?this.setAttribute("narrow",""):this.removeAttribute("narrow"),e.has("config")&&(this._displayedContacts=[],this._totalCount=0,this._loadCounts(),this._loadPage(!0))}render(){return K`
        ...
        <div class="nodes-header">
          ...
          <div class="header-actions">
            <div class="search-bar" style="flex: 1;">
              ...
              ${this._searchQuery?K`<button class="clear-search" @click=${()=>{this._searchQuery="",this._loadPage(!0)}}>✕</button>`:W}
            </div>
    ...
    `}_renderL2Buttons(){return["clients","repeaters","room_servers","sensors"].filter(e=>this._typeCounts[e]>0).map(e=>{const t=this._typeFilter===e;return K`
      ...
      `:W}
    `}_renderEmptyState(){const e=this._primaryFilter,t=this._typeFilter;let i=K`<svg viewBox="0 0 24 24" width="32" height="32" fill="currentColor" opacity="0.5"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>`,o="No nodes found",r="";return this._searchQuery?(o="No matching nodes",r=`No results for "${this._searchQuery}"`):"added"===e?(o="No added contacts",r=t?`No added ${Rt[t].toLowerCase()}`:"Add discovered contacts to see them here"):"discovered"===e?(o="No discovered nodes",r=t?`No discovered ${Rt[t].toLowerCase()}`:"Nodes seen on the mesh will appear here"):"all"===e&&(o="No nodes",r="No contacts or discovered nodes yet"),K`
      <div class="empty-state">
        <div class="empty-icon">${i}</div>
        <div class="empty-text">${o}</div>
        ${r?K`<div class="empty-subtext">${r}</div>`:W}
      </div>
    `}_openNodeDetail(e){this._selectedNode=e,this._nodeDetailDialogOpen=!0}_dispatchNodeAction(e){"add-contact"!==e&&"remove-contact"!==e||(this._pendingAction=e),this.dispatchEvent(new CustomEvent("node-action",{detail:{action:e,node:this._selectedNode},bubbles:!0,composed:!0})),"message"!==e&&"delete"!==e||(this._nodeDetailDialogOpen=!1)}clearPendingAction(){this._pendingAction=null}async refreshAfterMutation(e){if(await Promise.all([this._loadPage(!0),this._loadCounts()]),this._nodeDetailDialogOpen&&this._selectedNode&&e){const t=this._displayedContacts.find(t=>!(!t.public_key||t.public_key!==e)||!(!t.pubkey_prefix||!e.startsWith(t.pubkey_prefix)));t?this._selectedNode={...t}:this._nodeDetailDialogOpen=!1}}};Ot.styles=a`
    :host {
      display: flex;
      flex-direction: column;
      width: 100%;
  ...
  `,e([ue({type:Array})],Ot.prototype,"contacts",void 0),e([ue({type:Array})],Ot.prototype,"channels",void 0),e([ue({type:Boolean})],Ot.prototype,"narrow",void 0),e([ue({type:Object})],Ot.prototype,"hass",void 0),e([ue({type:Object})],Ot.prototype,"config",void 0),e([me()],Ot.prototype,"_viewportNarrow",void 0),e([me()],Ot.prototype,"_primaryFilter",void 0),e([me()],Ot.prototype,"_typeFilter",void 0),e([me()],Ot.prototype,"_searchQuery",void 0),e([me()],Ot.prototype,"_displayedContacts",void 0),e([me()],Ot.prototype,"_totalCount",void 0),e([me()],Ot.prototype,"_typeCounts",void 0),e([me()],Ot.prototype,"_l1Counts",void 0),e([me()],Ot.prototype,"_loading",void 0),e([me()],Ot.prototype,"_selectedNode",void 0),e([me()],Ot.prototype,"_nodeDetailDialogOpen",void 0),e([me()],Ot.prototype,"_pendingAction",void 0),e([me()],Ot.prototype,"_sortBy",void 0),Ot=e([pe("meshcore-nodes-page")],Ot);const It=[{step:"generating",label:"Generating new key"},{step:"importing",label:"Sending key to device"},{step:"rebooting",label:"Rebooting device"},{step:"reconnecting",label:"Waiting for device reconnect"},{step:"reloading",label:"Reloading MeshCore integration"},{step:"verifying",label:"Verifying new identity"}];let Tt=class extends de{constructor(){super(),this.narrow=!1,this._deviceConfig=null,this._loading=!0,this._error=null,this._editValues={},this._saving=!1,this._commandDialogOpen=!1,this._confirmAction=null,this._confirmDialogOpen=!1,this._locationSource="manual",this._importKeyValue="",this._deviceEntities={},this._meshcoreDeviceMap={},this._entityRegistryLoaded=!1,this._hiddenSensors={},this._contextMenu=null,this._overlayPointerStarted=!1,this._settingsModalOpen=!1,this._keyManagementModalOpen=!1,this._identityFlowState={kind:"closed"},this._identityFlowUnsubscribe=null,this._renameSuccess=null,this._hiddenSensorsModalKey=null,this._statusMessage=null,this._statusMessageTimeout=null,this._onCompanionTrace=()=>{const e=this.selectedDevice?.entry_id;this.dispatchEvent(new CustomEvent("companion-trace-requested",{detail:{entryId:e},bubbles:!0,composed:!0}))},We(this,{isOpen:()=>null!==this._contextMenu,onEscape:()=>this._closeContextMenu(),getScope:()=>this.shadowRoot?.querySelector('[data-a11y="tile-context"]')}),We(this,{isOpen:()=>this._settingsModalOpen,onEscape:()=>this._closeSettingsModal(),getScope:()=>this.shadowRoot?.querySelector('[data-a11y="companion-settings"]')}),We(this,{isOpen:()=>this._keyManagementModalOpen,onEscape:()=>this._closeKeyManagementModal(),getScope:()=>this.shadowRoot?.querySelector('[data-a11y="key-management"]')}),We(this,{isOpen:()=>null!==this._hiddenSensorsModalKey,onEscape:()=>this._closeHiddenSensorsModal(),getScope:()=>this.shadowRoot?.querySelector('[data-a11y="hidden-sensors"]')}),We(this,{isOpen:()=>"closed"!==this._identityFlowState.kind,onEscape:()=>{"success"!==this._identityFlowState.kind&&"failure"!==this._identityFlowState.kind||this._closeIdentityFlowModal()},getScope:()=>this.shadowRoot?.querySelector('[data-a11y="identity-flow"]')}),We(this,{isOpen:()=>null!==this._renameSuccess,onEscape:()=>this._closeRenameSuccessModal(),getScope:()=>this.shadowRoot?.querySelector('[data-a11y="rename-success"]')})}connectedCallback(){super.connectedCallback(),this._loadDeviceConfig(),this._loadHiddenSensors()}disconnectedCallback(){super.disconnectedCallback(),null!==this._statusMessageTimeout&&(clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=null)}updated(e){e.has("config")&&this._loadDeviceConfig(),e.has("hass")&&this.hass&&!this._entityRegistryLoaded&&this._loadEntityRegistry()}async _loadDeviceConfig(){if(this.hass){this._loading=!0,this._error=null;try{this._deviceConfig=await Ce(this.hass,this.config?.entry_id),this._deviceConfig?.location_source&&(this._locationSource=this._deviceConfig.location_source)}catch(e){this._error=`Failed to load device configuration: ${String(e)}`}finally{this._loading=!1}}}render(){return this._loading?K`
      ...
      ${this._keyManagementModalOpen?K`
    ...
    `:K`<div>No device config loaded</div>`}_renderCompanionCard(){if(!this.selectedDevice)return W;const e=this.selectedDevice,t=e.connected,i=this._getCompanionDeviceKey(),o=this._getCompanionEntities(),r=(this._hiddenSensors[i]||[]).length,s=o.find(e=>e.entity_id.includes("node_count")),a=s?this.hass?.states[s.entity_id]?.state:void 0,n=a&&"unavailable"!==a&&"unknown"!==a?a:void 0;return K`
          ...
          <div class="section-title">
            ...
            <div>
              ...
              <div class="device-meta">
                ...
                <span>Key: ${e.pubkey_prefix}</span>
                ${void 0!==n?K`<span>Added nodes: ${n}</span>`:W}
              </div>
            </div>
          </div>
          <div style="display:flex;align-items:center;gap:4px;">
    ...
    `}_renderHiddenSensorsModal(){const e=this._hiddenSensorsModalKey,t=(this._hiddenSensors[e]||[]).map(e=>{let t=e;for(const i of Object.values(this._deviceEntities)){const o=i.find(t=>t.entity_id===e);if(o){t=o.label;break}}return{entityId:e,label:t}});return K`
      <div class="modal-overlay" @click=${this._closeHiddenSensorsModal}>
        <div class="modal-card" data-a11y="hidden-sensors"
             role="dialog" aria-modal="true" aria-label="Hidden sensors"
             @click=${e=>e.stopPropagation()}>
    ...
    `}_renderDeviceInfo(){if(this._deviceConfig)return K`
      <div class="info-row">
      ...
      ${this._deviceConfig.connection_type?K`
        <div class="info-row">
          <span class="info-label">Connection</span>
          <span class="info-value">${this._deviceConfig.connection_type.toUpperCase()}${this._deviceConfig.connection_address?K` — ${this._deviceConfig.connection_address}`:""}</span>
        </div>
      `:""}
    ...
    `}_renderRadioSettings(){if(!this._deviceConfig)return;const e=this._hasChanges("radio-settings",["tx_power","frequency","bandwidth","spreading_factor","coding_rate","path_hash_mode"]);return K`
      ...
      <div class="section-row">
        <div class="form-group-inline">
          ...
          <select
            ...
            ${[7.8,10.4,15.6,20.8,31.25,41.7,62.5,125,250,500].map(e=>{const t=this._editValues.bandwidth??this._deviceConfig.bandwidth??250;return K`<option value=${e} ?selected=${Number(t)===e}>${e}</option>`})}
          </select>
        </div>
        <div class="form-group-inline">
          ...
          <select
            ...
            ${[7,8,9,10,11,12].map(e=>{const t=this._editValues.spreading_factor??this._deviceConfig.spreading_factor??11;return K`<option value=${e} ?selected=${Number(t)===e}>${e}</option>`})}
          </select>
        </div>
      </div>
      ...
      <div class="section-row">
        <div class="form-group-inline">
          ...
          <select
            ...
            ${[5,6,7,8].map(e=>{const t=this._editValues.coding_rate??this._deviceConfig.coding_rate??5;return K`<option value=${e} ?selected=${Number(t)===e}>${e}</option>`})}
          </select>
        </div>
        <div class="form-group-inline">
          ...
          <select
            ...
            ${[[0,"0 - 1 byte"],[1,"1 - 2 byte"],[2,"2 - 3 byte"]].map(([e,t])=>{const i=this._editValues.path_hash_mode??this._deviceConfig.path_hash_mode??0;return K`<option value=${e} ?selected=${Number(i)===e}>${t}</option>`})}
          </select>
        </div>
      </div>
    ...
    `}_renderIdentityManagement(){return K`
    ...
    `}_hasChanges(e,t){return!!this._deviceConfig&&t.some(e=>void 0!==this._editValues[e]&&this._editValues[e]!==this._deviceConfig[e])}async _handleApply(e){if(!this.hass||!this._deviceConfig)return;let t=[];switch(e){case"device-name":t=["name"];break;case"radio-settings":t=["tx_power","frequency","bandwidth","spreading_factor","coding_rate","path_hash_mode"]}const i={};for(const e of t)void 0!==this._editValues[e]&&(i[e]=this._editValues[e]);this._saving=!0;try{const e=await Se(this.hass,i,this.config?.entry_id);if(e.success){this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...i});for(const e of t)delete this._editValues[e];this._editValues={...this._editValues},e.rename?this._renameSuccess=e.rename:this._showStatusMessage(`Saved: ${t.join(", ")}`,"success")}else this._showStatusMessage("Save failed","error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}async _copyToClipboard(e){try{await navigator.clipboard.writeText(e),this._showStatusMessage("Copied to clipboard","success")}catch{this._showStatusMessage("Failed to copy","error")}}_showStatusMessage(e,t){this._statusMessage={text:e,type:t},null!==this._statusMessageTimeout&&clearTimeout(this._statusMessageTimeout),this._statusMessageTimeout=window.setTimeout(()=>{this._statusMessage=null,this._statusMessageTimeout=null},5e3)}_handleNameSave(){const e=this._editValues.name,t=this._deviceConfig?.name;if(void 0===e||e===t)return;const i=e=>(e||"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_|_$/g,""),o=i(t??""),r=i(String(e));this._confirmAction={title:"Rename Device",message:`Renaming the device will rename all entity IDs ending in _${o} to _${r}. Any automations, scripts, or dashboards referencing entity IDs by the old name will need updating. A repair issue will list every renamed entity. Continue?`,onConfirm:async()=>{await this._handleApply("device-name")}},this._confirmDialogOpen=!0}_handleRebootFromModal(){this._settingsModalOpen=!1,this._confirmAction={title:"Reboot Device",message:"Are you sure you want to reboot the device? The device will be temporarily unavailable.",onConfirm:()=>this._executeDeviceCommand("reboot")},this._confirmDialogOpen=!0}async _executeDeviceCommand(e){if(this.hass)try{const t=await Me(this.hass,e,void 0,this.config?.entry_id);t.success?this._showStatusMessage(`Device ${e} initiated`,"success"):this._showStatusMessage(`Command failed: ${t.response}`,"error")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}}async _applyLocation(){if(this.hass&&this._deviceConfig){this._saving=!0;try{const e=["latitude","longitude"],t={};if("ha_location"===this._locationSource){const e=this.hass.states["zone.home"];if(!e||null==e.attributes.latitude||null==e.attributes.longitude)return void this._showStatusMessage("Could not read zone.home coordinates from Home Assistant","error");t.latitude=e.attributes.latitude,t.longitude=e.attributes.longitude}else for(const i of e)void 0!==this._editValues[i]&&(t[i]=this._editValues[i]);if(Object.keys(t).length>0){if(!(await Se(this.hass,t,this.config?.entry_id)).success)return void this._showStatusMessage("Failed to save coordinates","error");this._deviceConfig&&(this._deviceConfig={...this._deviceConfig,...t});for(const t of e)delete this._editValues[t];this._editValues={...this._editValues}}if(!(await async function(e,t,i){try{const o={type:"meshcore_chat/set_location_source",source:t};return i&&(o.entry_id=i),await e.callWS(o)}catch{return{success:!1}}}(this.hass,this._locationSource,this.config?.entry_id)).success)return void this._showStatusMessage("Failed to update location source","error");await this._loadDeviceConfig(),this._showStatusMessage("Location settings applied","success")}catch(e){this._showStatusMessage(`Error: ${String(e)}`,"error")}finally{this._saving=!1}}}_showRegenIdentityConfirm(){this._confirmAction={title:"Regenerate Identity",message:"This will create a new cryptographic identity, reboot the device, and migrate all entity IDs to the new key prefix. Existing automations referencing entity IDs by the old prefix will need updating. All contacts must re-add this device. This cannot be undone.",requireTyped:"REGENERATE",onConfirm:async()=>{this.hass&&(this._closeKeyManagementModal(),this._startIdentityFlow("regenerate",{type:"meshcore_chat/regenerate_identity",payload:this.config?.entry_id?{entry_id:this.config.entry_id}:{}}))}},this._confirmDialogOpen=!0}_handleImportKeyConfirm(){const e=this._importKeyValue.trim().replace(/\s+/g,"");e&&(64===e.length||128===e.length?/^[0-9a-fA-F]+$/.test(e)?(this._confirmAction={title:"Import Private Key",message:"Importing a private key will replace the device identity, reboot the device, and migrate all entity IDs to the new key prefix. Existing automations referencing entity IDs by the old prefix will need updating. All contacts must re-add this device.",requireTyped:"IMPORT",onConfirm:()=>this._importIdentityKey()},this._confirmDialogOpen=!0):this._showStatusMessage("Private key must be hex (0-9, a-f)","error"):this._showStatusMessage("Private key must be 64 or 128 hex characters","error"))}async _importIdentityKey(){if(!this.hass||!this._importKeyValue.trim())return;const e=this._importKeyValue.trim().replace(/\s+/g,"");this._closeKeyManagementModal(),this._importKeyValue="";const t={private_key:e};this.config?.entry_id&&(t.entry_id=this.config.entry_id),this._startIdentityFlow("import",{type:"meshcore_chat/import_identity",payload:t})}_startIdentityFlow(e,t){if(!this.hass)return;this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null),this._identityFlowState={kind:"progress",flow:e,currentStep:"generating",completedSteps:new Set};const{unsubscribe:i}=function(e,t,i,o){let r,s=null;const a=new Promise(e=>{r=e});let n={success:!1,code:"unknown",message:"Identity flow terminated without a result event."};return e.connection.subscribeMessage(e=>{if("done"===e.step&&e.success&&e.old_pubkey&&e.new_pubkey){const t={success:!0,old_pubkey:e.old_pubkey,new_pubkey:e.new_pubkey,warning:e.warning};n=t,o({type:"result",data:t})}else"done"!==e.step&&o({type:"progress",step:e.step})},{type:t,...i}).then(e=>{s=e,r(n)}).catch(e=>{const t={success:!1,code:e.code||"error",message:e.message||"Identity flow failed."};o({type:"error",data:t}),r(t)}),{unsubscribe:()=>{s&&s()},done:a}}(this.hass,t.type,t.payload,t=>{if("progress"===t.type){if("progress"!==this._identityFlowState.kind)return;const e=new Set(this._identityFlowState.completedSteps);e.add(this._identityFlowState.currentStep),this._identityFlowState={...this._identityFlowState,currentStep:t.step,completedSteps:e}}else"result"===t.type?this._identityFlowState={kind:"success",flow:e,oldPubkey:t.data.old_pubkey,newPubkey:t.data.new_pubkey,warning:t.data.warning}:"error"===t.type&&(this._identityFlowState={kind:"failure",flow:e,code:t.data.code,message:t.data.message})});this._identityFlowUnsubscribe=i}_closeIdentityFlowModal(){this._identityFlowUnsubscribe&&(this._identityFlowUnsubscribe(),this._identityFlowUnsubscribe=null);const e="success"===this._identityFlowState.kind;this._identityFlowState={kind:"closed"},e&&this._loadDeviceConfig()}_renderIdentityFlowModal(){const e=this._identityFlowState;if("closed"===e.kind)return W;const t="regenerate"===e.flow?"Regenerate Identity":"Import Private Key",i="regenerate"===e.flow?"Regenerating Identity":"Importing Identity",o="regenerate"===e.flow?"Identity Regenerated":"Identity Imported",r="regenerate"===e.flow?"Identity Regeneration Failed":"Identity Import Failed";let s,a;"progress"===e.kind?(s=K`
        ...
        <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 8px;">
          ${It.map(t=>{const i=e.completedSteps.has(t.step),o=e.currentStep===t.step;let r="○",s="var(--secondary-text-color)";return i?(r="✓",s="var(--success-color, #28a745)"):o&&(r="⏳",s="var(--primary-color)"),K`
      ...
      `,a=K`
        <button class="modal-action" @click=${this._closeIdentityFlowModal}>Close</button>
      `);const n="progress"===e.kind?i:"success"===e.kind?o:r;return K`
      <div class="modal-overlay">
        <div class="modal-card" data-a11y="identity-flow"
          ...
          <div class="modal-body" style="padding: 20px;">
            ${s}
            ${a?K`<div style="margin-top: 20px; display: flex; justify-content: flex-end;">${a}</div>`:W}
          </div>
        </div>
      </div>
    `}_closeRenameSuccessModal(){this._renameSuccess=null,this._loadDeviceConfig(),this.dispatchEvent(new CustomEvent("device-renamed",{bubbles:!0,composed:!0}))}_renderRenameSuccessModal(){const e=this._renameSuccess;return e?K`
    ...
    `],e([ue({type:Object})],Tt.prototype,"hass",void 0),e([ue({type:Object})],Tt.prototype,"config",void 0),e([ue({type:Boolean})],Tt.prototype,"narrow",void 0),e([ue({type:Object})],Tt.prototype,"selectedDevice",void 0),e([me()],Tt.prototype,"_deviceConfig",void 0),e([me()],Tt.prototype,"_loading",void 0),e([me()],Tt.prototype,"_error",void 0),e([me()],Tt.prototype,"_editValues",void 0),e([me()],Tt.prototype,"_saving",void 0),e([me()],Tt.prototype,"_commandDialogOpen",void 0),e([me()],Tt.prototype,"_confirmAction",void 0),e([me()],Tt.prototype,"_confirmDialogOpen",void 0),e([me()],Tt.prototype,"_locationSource",void 0),e([me()],Tt.prototype,"_importKeyValue",void 0),e([me()],Tt.prototype,"_deviceEntities",void 0),e([me()],Tt.prototype,"_meshcoreDeviceMap",void 0),e([me()],Tt.prototype,"_entityRegistryLoaded",void 0),e([me()],Tt.prototype,"_hiddenSensors",void 0),e([me()],Tt.prototype,"_contextMenu",void 0),e([me()],Tt.prototype,"_settingsModalOpen",void 0),e([me()],Tt.prototype,"_keyManagementModalOpen",void 0),e([me()],Tt.prototype,"_identityFlowState",void 0),e([me()],Tt.prototype,"_renameSuccess",void 0),e([me()],Tt.prototype,"_hiddenSensorsModalKey",void 0),e([me()],Tt.prototype,"_statusMessage",void 0),Tt=e([pe("meshcore-settings-page")],Tt);let Ft=class extends de{constructor(){super(),this.open=!1,this.contactName="",this.result=null,this.error="",this.availableRepeaters=[],this.targetContact=null,this.pathMode="discovery",this.pathHops=[],this.enteredPath="",this._repeaterFilter="",this._running=!1,this._onPathModeChange=e=>{this.pathMode=e.target.value},this._onExplicitPathInput=e=>{this.enteredPath=e.target.value},this._onRunTrace=()=>{if(!this._canRunTrace())return;const e="discovery"===this.pathMode?void 0:this._buildPathString();this._running=!0,this.dispatchEvent(new CustomEvent("trace-requested",{detail:{pathMode:this.pathMode,path:e},bubbles:!0,composed:!0}))},We(this,{isOpen:()=>this.open,onEscape:()=>this._close()})}willUpdate(e){if(e.has("open")&&this.open&&!e.get("open")){const e=this.targetContact;if(!e||2!==e.type&&3!==e.type&&4!==e.type)this.pathMode="discovery",this.pathHops=[];else{this.pathMode="select";const t=this._resolveCachedHops(e);this.pathHops=t||[]}this.enteredPath="",this._repeaterFilter="",this._running=!1}(e.has("result")&&this.result||e.has("error")&&this.error)&&(this._running=!1)}_resolveCachedHops(e){if(1!==(e.out_path_hash_mode??0))return null;const t=(e.out_path||"").toLowerCase(),i=e.out_path_len??0;if(!t||i<=0)return null;if(t.length<4*i)return null;const o=[];for(let e=0;e<i;e++){const i=t.substring(4*e,4*(e+1)),r=this.availableRepeaters.find(e=>(e.pubkey_prefix||"").toLowerCase().startsWith(i));if(!r)return null;o.push(r)}return o}render(){return this.open?K`
      <div class="dialog-backdrop" @click=${this._close}>
        <div
          class="dialog"
          role="dialog"
    ...
    `:K``}_renderBody(){return this.error?K`<div class="error-box">${this.error}</div>`:this.result?this._renderResult(this.result):this._running?K`<div class="info-value">Tracing…</div>`:this._renderInput()}_renderInput(){return K`
      <div class="form-group">
      ...
      ${"discovery"===this.pathMode?K`<div class="info-item path-hint">
      ...
      ${"discovery"!==this.pathMode&&this._canRunTrace()?K`<div class="info-item">
    ...
    `}_renderRepeaterPicker(){const e=new Set(this.pathHops.map(e=>e.public_key)),t=this._repeaterFilter.trim().toLowerCase(),i=[...this.availableRepeaters].filter(t=>!e.has(t.public_key)).filter(e=>{if(!t)return!0;const i=(e.adv_name||"").toLowerCase(),o=(e.pubkey_prefix||"").toLowerCase();return i.includes(t)||o.startsWith(t)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||"")),o=this.targetContact?.adv_name||this.targetContact?.pubkey_prefix||"(no target)",r=this.targetContact?.pubkey_prefix?.substring(0,2).toUpperCase()||"--";return K`
      <div class="info-item">
        ...
        <div class="repeater-picker">
          <div class="picker-column">
            ...
            <div class="picker-list">
              ${0===i.length?K`<div class="picker-empty">${t?"No matches":"No repeaters available"}</div>`:i.map(e=>K`
                      <div
                        class="picker-item"
          ...
          <div class="picker-column">
            ...
            <div class="picker-list">
              ${0===this.pathHops.length?K`<div class="picker-empty">Click a repeater to add (or leave empty for direct-neighbor)</div>`:this.pathHops.map((e,t)=>K`
    ...
    `}_renderExplicitInput(){const e=!!this.enteredPath&&!this._isValidExplicitHops(),t=this.targetContact?.adv_name||this.targetContact?.pubkey_prefix||"(no target)",i=this.targetContact?.pubkey_prefix?.substring(0,2).toUpperCase()||"--";return K`
      <div class="info-item">
    ...
    `}_addRepeater(e){this.pathHops=[...this.pathHops,e]}_removeRepeater(e){this.pathHops=this.pathHops.filter((t,i)=>i!==e)}_moveRepeater(e,t){const i=e+t;if(i<0||i>=this.pathHops.length)return;const o=[...this.pathHops];[o[e],o[i]]=[o[i],o[e]],this.pathHops=o}_isValidExplicitHops(){const e=this.enteredPath.trim();if(!e)return!0;const t=e.split(",").map(e=>e.trim());if(0===t.length)return!1;const i=t[0].length;if(![2,4,8].includes(i))return!1;const o=/^[0-9a-fA-F]+$/;return t.every(e=>e.length===i&&o.test(e))}_canRunTrace(){return"discovery"===this.pathMode||("select"===this.pathMode?!!this.targetContact:"explicit"===this.pathMode&&!!this.targetContact&&this._isValidExplicitHops())}_buildPathString(){if("select"===this.pathMode){if(!this.targetContact)return"";const e=this.targetContact.pubkey_prefix.substring(0,2).toUpperCase(),t=this.pathHops.map(e=>e.pubkey_prefix.substring(0,2).toUpperCase());return 0===t.length?e:[...t,e,...[...t].reverse()].join(",")}if("explicit"===this.pathMode){if(!this.targetContact)return"";const e=this.targetContact.pubkey_prefix.substring(0,2).toUpperCase(),t=this.enteredPath.trim();if(!t)return e;const i=t.split(",").map(e=>e.trim().toUpperCase());return[...i,e,...[...i].reverse()].join(",")}return""}_renderResult(e){const t=(e.path||[]).filter(e=>e.hash);return K`
      ...
      ${null!==e.final_snr&&void 0!==e.final_snr?K`
            <div class="info-item">
      ...
      ${t.length>0?K`
          ...
          `:K``}
    `}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("trace-dialog-closed",{bubbles:!0,composed:!0}))}};Ft.styles=[ve,a`
  ...
  `],e([ue({type:Boolean})],Ft.prototype,"open",void 0),e([ue({type:String})],Ft.prototype,"contactName",void 0),e([ue({type:Object})],Ft.prototype,"result",void 0),e([ue({type:String})],Ft.prototype,"error",void 0),e([ue({type:Array})],Ft.prototype,"availableRepeaters",void 0),e([ue({type:Object})],Ft.prototype,"targetContact",void 0),e([me()],Ft.prototype,"pathMode",void 0),e([me()],Ft.prototype,"pathHops",void 0),e([me()],Ft.prototype,"enteredPath",void 0),e([me()],Ft.prototype,"_repeaterFilter",void 0),e([me()],Ft.prototype,"_running",void 0),Ft=e([pe("meshcore-trace-dialog")],Ft);let Et=class extends de{constructor(){super(),this.open=!1,this.contacts=[],this._typeFilter="all",this._search="",this._onTypeChange=e=>{this._typeFilter=e.target.value},this._onSearchInput=e=>{this._search=e.target.value},this._close=()=>{this.dispatchEvent(new CustomEvent("target-picker-closed",{bubbles:!0,composed:!0}))},We(this,{isOpen:()=>this.open,onEscape:()=>this._close()})}willUpdate(e){e.has("open")&&this.open&&!e.get("open")&&(this._typeFilter="all",this._search="")}render(){if(!this.open)return K``;const e=this._search.trim().toLowerCase(),t=this.contacts.filter(e=>{switch(this._typeFilter){case"all":default:return!0;case"client":return 1===e.type;case"repeater":return 2===e.type;case"room_server":return 3===e.type;case"sensor":return 4===e.type}}).filter(t=>{if(!e)return!0;const i=(t.adv_name||"").toLowerCase(),o=(t.pubkey_prefix||"").toLowerCase();return i.includes(e)||o.startsWith(e)}).sort((e,t)=>(e.adv_name||"").localeCompare(t.adv_name||""));return K`
      <div class="dialog-backdrop" @click=${this._close}>
        <div
          class="dialog"
          role="dialog"
          ...
          <div class="dialog-content">
            ...
            <div class="results-list">
              ${0===t.length?K`<div class="empty">No matching contacts</div>`:t.map(e=>K`
                    <div
                      class="result-row"
    ...
    `}_iconFor(e){switch(e){case 2:return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 2a2 2 0 012 2c0 .74-.4 1.39-1 1.73V10h4.27c.15-.86.45-1.66.87-2.36l-1.82-1.06a.5.5 0 01-.18-.68l.5-.87a.5.5 0 01.68-.18l1.81 1.05C19.66 4.66 20.78 4 22 4v2c-.8 0-1.54.32-2.08.84l1.5 2.6a.5.5 0 01-.18.68l-.87.5a.5.5 0 01-.68-.18L18.2 7.92c-.14.65-.2 1.33-.2 2.08 0 3.31-2.69 6-6 6s-6-2.69-6-6 2.69-6 6-6z"/></svg>`;case 3:return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M4 6h16v4H4V6zm0 8h16v4H4v-4zm2-6.5A.5.5 0 116 7a.5.5 0 010 .5zm0 8A.5.5 0 116 15a.5.5 0 010 .5z"/></svg>`;case 4:return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 2a4 4 0 00-4 4v7.55A5.5 5.5 0 1015.5 20a5.47 5.47 0 00.5-2.45V6a4 4 0 00-4-4zm0 2a2 2 0 012 2v8.1a3.5 3.5 0 11-4 0V6a2 2 0 012-2z"/></svg>`;default:return K`<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>`}}_select(e){this.dispatchEvent(new CustomEvent("target-selected",{detail:e,bubbles:!0,composed:!0}))}};Et.styles=[ve,a`
      :host { display: contents; }
    ...
    `],e([ue({type:Boolean})],Et.prototype,"open",void 0),e([ue({type:Array})],Et.prototype,"contacts",void 0),e([me()],Et.prototype,"_typeFilter",void 0),e([me()],Et.prototype,"_search",void 0),Et=e([pe("meshcore-target-picker")],Et);let Nt=class extends de{constructor(){super(),this.narrow=!1,this._config=null,this._activeTab="chat",this._devices=[],this._contacts=[],this._channels=[],this._selectedEntryId=null,this._loading=!0,this._loadingStarted=!1,this._error=null,this._unsubscribeList=[],this._unread=new Re,this._pendingChatTarget=null,this._activeChatEntityId=null,this._deviceDropdownOpen=!1,this._onDocClickForDropdown=e=>{const t=e.composedPath?e.composedPath():[],i=this.shadowRoot?.querySelector(".device-info-wrap");i&&t.includes(i)||this._closeDeviceDropdown()},this._onDocKeyForDropdown=e=>{"Escape"===e.key&&this._closeDeviceDropdown()},this._traceDialogOpen=!1,this._traceDialogContactName="",this._traceDialogResult=null,this._traceDialogError="",this._traceDialogPubkeyPrefix="",this._traceDialogEntryId=void 0,this._traceDialogTargetContact=null,this._targetPickerOpen=!1,this._pendingTraceEntryId=void 0,this._onTraceRequested=async e=>{if(!this.hass)return;const{pathMode:t,path:i}=e.detail;try{const e=await async function(e,t,i,o="discovery",r){const s={type:"meshcore_chat/trace",pubkey_prefix:t};return i&&(s.entry_id=i),"select"!==o&&"explicit"!==o||!r||(s.path=r),e.callWS(s)}(this.hass,this._traceDialogPubkeyPrefix,this._traceDialogEntryId,t,i);this._traceDialogResult=e}catch(e){this._traceDialogError=e?.message||e?.code||"Unknown error"}},this._onCompanionTraceRequested=e=>{this._pendingTraceEntryId=e.detail?.entryId??this._selectedEntryId??void 0,this._targetPickerOpen=!0},this._onTargetPicked=e=>{const t=e.detail;this._targetPickerOpen=!1,t&&(this._traceDialogPubkeyPrefix=t.pubkey_prefix,this._traceDialogEntryId=this._pendingTraceEntryId,this._traceDialogContactName=t.adv_name||t.pubkey_prefix,this._traceDialogTargetContact=t,this._traceDialogResult=null,this._traceDialogError="",this._traceDialogOpen=!0)},this._unread.onMarkReadRequested(e=>{this._handleMarkReadRequested(e)})}connectedCallback(){super.connectedCallback(),this._loadData(),this._setupSubscriptions()}disconnectedCallback(){super.disconnectedCallback(),this._teardownSubscriptions(),this._closeDeviceDropdown()}_toggleDeviceDropdown(){this._deviceDropdownOpen?this._closeDeviceDropdown():this._openDeviceDropdown()}_openDeviceDropdown(){this._deviceDropdownOpen||(this._deviceDropdownOpen=!0,setTimeout(()=>{document.addEventListener("click",this._onDocClickForDropdown,!0),document.addEventListener("keydown",this._onDocKeyForDropdown,!0)},0))}_closeDeviceDropdown(){this._deviceDropdownOpen&&(this._deviceDropdownOpen=!1,document.removeEventListener("click",this._onDocClickForDropdown,!0),document.removeEventListener("keydown",this._onDocKeyForDropdown,!0))}_selectDevice(e){e!==this._selectedEntryId&&(this._selectedEntryId=e,this._pendingChatTarget=null,Promise.all([this._loadDeviceData(),this._loadUnreadCounts()])),this._closeDeviceDropdown()}_setupSubscriptions(){this._teardownSubscriptions(),this.hass?.connection?.subscribeEvents&&(this.hass.connection.subscribeEvents(e=>{e.data.entry_id===this._selectedEntryId&&this._loadDeviceData()},"meshcore_channels_updated").then(e=>{this._unsubscribeList.push(e)}),this.hass.connection.subscribeEvents(e=>{e.data.entry_id===this._selectedEntryId&&this._loadDeviceData()},"meshcore_channel_removed").then(e=>{this._unsubscribeList.push(e)}),this.hass.connection.subscribeEvents(e=>{this._activeChatEntityId&&e.data?.entity_id===this._activeChatEntityId||this._loadUnreadCounts()},"meshcore_unread_updated").then(e=>{this._unsubscribeList.push(e)}))}_teardownSubscriptions(){this._unsubscribeList.length>0&&(this._unsubscribeList.forEach(e=>{try{e()}catch(e){}}),this._unsubscribeList=[])}updated(e){e.has("hass")&&this.hass&&!this._config&&!this._loadingStarted&&this._loadData()}get _selectedDevice(){return this._devices.find(e=>e.entry_id===this._selectedEntryId)}render(){if(this._loading)return K`
      ...
      `}const e=this._selectedDevice;return K`
      <div class="panel">
        <div class="panel-header">
          <div class="header-left">
            ${this.narrow||"always_hidden"===this.hass?.dockedSidebar?K`<button class="menu-icon" @click=${this._toggleMenu} aria-label="Toggle sidebar">
          ...
          <div class="header-right">
            ${e&&null!==this._getNodeStatus(e)?K`
            ...
            ${e&&null!==this._getBatteryLevel(e)?K`
        ...
        ${this._error?K`<div class="error-banner">${this._error}</div>`:K``}
    ...
    `}_renderActivePage(){switch(this._activeTab){case"chat":return K`
          <meshcore-chat-page
            .hass=${this.hass}
            .config=${this._config}
            ...
            @channels-changed=${()=>this._loadDeviceData()}></meshcore-chat-page>`;case"devices":return K`
          <meshcore-devices-page
            .hass=${this.hass}
            .config=${this._config}
            .selectedDevice=${this._selectedDevice}
            .narrow=${this.narrow}></meshcore-devices-page>`;case"nodes":return K`
          <meshcore-nodes-page
            .hass=${this.hass}
            .config=${this._config}
            .contacts=${this._contacts}
            ...
            @contacts-changed=${()=>this._loadDeviceData()}></meshcore-nodes-page>`;case"settings":return K`
    ...
    `],e([ue({type:Object})],Nt.prototype,"hass",void 0),e([ue({type:Boolean,reflect:!0})],Nt.prototype,"narrow",void 0),e([ue({type:Object})],Nt.prototype,"panel",void 0),e([me()],Nt.prototype,"_config",void 0),e([me()],Nt.prototype,"_activeTab",void 0),e([me()],Nt.prototype,"_devices",void 0),e([me()],Nt.prototype,"_contacts",void 0),e([me()],Nt.prototype,"_channels",void 0),e([me()],Nt.prototype,"_selectedEntryId",void 0),e([me()],Nt.prototype,"_loading",void 0),e([me()],Nt.prototype,"_loadingStarted",void 0),e([me()],Nt.prototype,"_error",void 0),e([me()],Nt.prototype,"_unsubscribeList",void 0),e([me()],Nt.prototype,"_pendingChatTarget",void 0),e([me()],Nt.prototype,"_deviceDropdownOpen",void 0),e([me()],Nt.prototype,"_traceDialogOpen",void 0),e([me()],Nt.prototype,"_traceDialogContactName",void 0),e([me()],Nt.prototype,"_traceDialogResult",void 0),e([me()],Nt.prototype,"_traceDialogError",void 0),e([me()],Nt.prototype,"_traceDialogPubkeyPrefix",void 0),e([me()],Nt.prototype,"_traceDialogEntryId",void 0),e([me()],Nt.prototype,"_traceDialogTargetContact",void 0),e([me()],Nt.prototype,"_targetPickerOpen",void 0),e([me()],Nt.prototype,"_pendingTraceEntryId",void 0),Nt=e([pe("meshcore-chat-panel")],Nt);export{Nt as MeshCorePanel};
